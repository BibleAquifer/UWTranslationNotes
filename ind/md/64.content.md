...
* **Associated ACAI Concepts:** kasihi (ID: `keyterm:Love`); bersaksi (ID: `keyterm:BearWitness`); Tuhan (ID: `deity:Lord`); nama (ID: `keyterm:Name`); jemaat (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** kekasih (ID: `keyterm:Beloved`); lakukan baik (ID: `keyterm:DoGood`); Tuhan (ID: `deity:Lord`); yang baik (ID: `keyterm:Good`)
