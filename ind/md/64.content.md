...
* **Associated ACAI Concepts:** kasihi (ID: `keyterm:Love`); bersaksi (ID: `keyterm:BearWitness`); jemaat (ID: `keyterm:Church`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** jemaat (ID: `keyterm:Church`); bersaksi (ID: `keyterm:BearWitness`); kasihi (ID: `keyterm:Love`); Tuhan (ID: `deity:Lord`); nama (ID: `keyterm:Name`)
