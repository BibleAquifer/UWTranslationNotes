...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); kasihi (ID: `keyterm:Love`); bersaksi (ID: `keyterm:BearWitness`); jemaat (ID: `keyterm:Church`)
...
* **Associated Passages:** 3 Yohanes 1:6-7
* **Associated Articles:** Keterhubungan - Hubungan Sebab dan Akibat (ID: `727567@UWTranslationManual`)

* **Associated ACAI Concepts:** jemaat (ID: `keyterm:Church`); bersaksi (ID: `keyterm:BearWitness`); nama (ID: `keyterm:Name`); Tuhan (ID: `deity:Lord`); kasihi (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** yang baik (ID: `keyterm:Good`); Tuhan (ID: `deity:Lord`); kekasih (ID: `keyterm:Beloved`); lakukan baik (ID: `keyterm:DoGood`)
