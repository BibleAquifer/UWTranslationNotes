...
* **Associated ACAI Concepts:** jemaat (ID: `keyterm:Church`); Tuhan (ID: `deity:Lord`); nama (ID: `keyterm:Name`); bersaksi (ID: `keyterm:BearWitness`); kasihi (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); kekasih (ID: `keyterm:Beloved`); yang baik (ID: `keyterm:Good`); lakukan baik (ID: `keyterm:DoGood`)
