...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); kebenaran (ID: `keyterm:Truth`); Paulus (ID: `person:Paul`); Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); orang pilihan (ID: `keyterm:Chosen`)
...
* **Associated ACAI Concepts:** Titus (ID: `person:Titus`); kebaikan (ID: `keyterm:Favor`); Tuhan (ID: `deity:Lord`); memperdamaikan (ID: `keyterm:Peace`); juruselamat (ID: `keyterm:Savior`); (kepunyaan) bersama (ID: `keyterm:InCommon`); Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** belas kasihan (ID: `keyterm:Mercy`); keselamatan (ID: `keyterm:Salvation`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Roh (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** selama, lamanya (ID: `keyterm:Always`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); kebaikan (ID: `keyterm:Favor`); kehidupan (ID: `keyterm:Life`); harapan (ID: `keyterm:Hope`)
