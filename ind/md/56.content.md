...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); Paulus (ID: `person:Paul`); orang pilihan (ID: `keyterm:Chosen`); Tuhan (ID: `deity:Lord`); kebenaran (ID: `keyterm:Truth`)
...
* **Associated ACAI Concepts:** kehidupan (ID: `keyterm:Life`); selama, lamanya (ID: `keyterm:Always`); janji (ID: `keyterm:Promise`); harapan (ID: `keyterm:Hope`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Titus (ID: `person:Titus`); (kepunyaan) bersama (ID: `keyterm:InCommon`); Yesus (ID: `person:Jesus.2`); kebaikan (ID: `keyterm:Favor`); memperdamaikan (ID: `keyterm:Peace`); percaya (ID: `keyterm:Believe`); juruselamat (ID: `keyterm:Savior`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** menghujat (ID: `keyterm:Blaspheme`); yang baik (ID: `keyterm:Good`); murni (ID: `keyterm:Pure`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** juruselamat (ID: `keyterm:Savior`); berbahagialah (ID: `keyterm:Happy`); kemuliaan (ID: `keyterm:Glory`); Yesus (ID: `person:Jesus.2`); harapan (ID: `keyterm:Hope`); Tuhan (ID: `deity:Lord`)
