...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yesus (ID: `person:Jesus.2`); kebenaran (ID: `keyterm:Truth`); orang pilihan (ID: `keyterm:Chosen`); Paulus (ID: `person:Paul`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); kehidupan (ID: `keyterm:Life`); janji (ID: `keyterm:Promise`); selama, lamanya (ID: `keyterm:Always`); harapan (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** Titus (ID: `person:Titus`); memperdamaikan (ID: `keyterm:Peace`); kebaikan (ID: `keyterm:Favor`); Tuhan (ID: `deity:Lord`); Yesus (ID: `person:Jesus.2`); (kepunyaan) bersama (ID: `keyterm:InCommon`); juruselamat (ID: `keyterm:Savior`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** murni (ID: `keyterm:Pure`); yang baik (ID: `keyterm:Good`); Tuhan (ID: `deity:Lord`); menghujat (ID: `keyterm:Blaspheme`)
