...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); kebenaran (ID: `keyterm:Truth`); orang pilihan (ID: `keyterm:Chosen`); Tuhan (ID: `deity:Lord`); Paulus (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** janji (ID: `keyterm:Promise`); harapan (ID: `keyterm:Hope`); selama, lamanya (ID: `keyterm:Always`); kehidupan (ID: `keyterm:Life`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Titus (ID: `person:Titus`); Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); (kepunyaan) bersama (ID: `keyterm:InCommon`); kebaikan (ID: `keyterm:Favor`); memperdamaikan (ID: `keyterm:Peace`); juruselamat (ID: `keyterm:Savior`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); suka akan yang baik (ID: `keyterm:LikingWhatIsGood`); khusus (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** murni (ID: `keyterm:Pure`); menghujat (ID: `keyterm:Blaspheme`); Tuhan (ID: `deity:Lord`); yang baik (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** kehidupan (ID: `keyterm:Life`); selama, lamanya (ID: `keyterm:Always`); duniawi (ID: `keyterm:Worldly`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** juruselamat (ID: `keyterm:Savior`); Yesus (ID: `person:Jesus.2`); harapan (ID: `keyterm:Hope`); berbahagialah (ID: `keyterm:Happy`); kemuliaan (ID: `keyterm:Glory`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** meminta (ID: `keyterm:AskFor`); menasihati (ID: `keyterm:Encourage`); kekuasaan (ID: `keyterm:Authority.2`)
...
* **Associated ACAI Concepts:** harapan (ID: `keyterm:Hope`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); kebaikan (ID: `keyterm:Favor`); selama, lamanya (ID: `keyterm:Always`); kehidupan (ID: `keyterm:Life`)
