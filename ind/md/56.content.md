...
* **Associated ACAI Concepts:** Paulus (ID: `person:Paul`); orang pilihan (ID: `keyterm:Chosen`); Tuhan (ID: `deity:Lord`); percaya (ID: `keyterm:Believe`); kebenaran (ID: `keyterm:Truth`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** harapan (ID: `keyterm:Hope`); janji (ID: `keyterm:Promise`); Tuhan (ID: `deity:Lord`); kehidupan (ID: `keyterm:Life`); selama, lamanya (ID: `keyterm:Always`)
...
* **Associated ACAI Concepts:** Titus (ID: `person:Titus`); kebaikan (ID: `keyterm:Favor`); (kepunyaan) bersama (ID: `keyterm:InCommon`); memperdamaikan (ID: `keyterm:Peace`); Tuhan (ID: `deity:Lord`); percaya (ID: `keyterm:Believe`); juruselamat (ID: `keyterm:Savior`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** kebaikan (ID: `keyterm:Favor`); harapan (ID: `keyterm:Hope`); kehidupan (ID: `keyterm:Life`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); selama, lamanya (ID: `keyterm:Always`)
