...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); Paulus (ID: `person:Paul`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`); kebenaran (ID: `keyterm:Truth`); orang pilihan (ID: `keyterm:Chosen`)
...
* **Associated ACAI Concepts:** Titus (ID: `person:Titus`); percaya (ID: `keyterm:Believe`); (kepunyaan) bersama (ID: `keyterm:InCommon`); Yesus (ID: `person:Jesus.2`); kebaikan (ID: `keyterm:Favor`); Tuhan (ID: `deity:Lord`); memperdamaikan (ID: `keyterm:Peace`); juruselamat (ID: `keyterm:Savior`)
...
* **Associated ACAI Concepts:** menghujat (ID: `keyterm:Blaspheme`); yang baik (ID: `keyterm:Good`); Tuhan (ID: `deity:Lord`); murni (ID: `keyterm:Pure`)
...
* **Associated ACAI Concepts:** belas kasihan (ID: `keyterm:Mercy`); keselamatan (ID: `keyterm:Salvation`); Roh (ID: `deity:HolySpirit`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`)
