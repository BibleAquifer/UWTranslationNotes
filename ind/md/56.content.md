...
* **Associated ACAI Concepts:** kehidupan (ID: `keyterm:Life`); harapan (ID: `keyterm:Hope`); selama, lamanya (ID: `keyterm:Always`); Tuhan (ID: `deity:Lord`); janji (ID: `keyterm:Promise`)
...
* **Associated ACAI Concepts:** Titus (ID: `person:Titus`); (kepunyaan) bersama (ID: `keyterm:InCommon`); juruselamat (ID: `keyterm:Savior`); memperdamaikan (ID: `keyterm:Peace`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`); kebaikan (ID: `keyterm:Favor`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** yang baik (ID: `keyterm:Good`); murni (ID: `keyterm:Pure`); menghujat (ID: `keyterm:Blaspheme`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** menasihati (ID: `keyterm:Encourage`); kekuasaan (ID: `keyterm:Authority.2`); meminta (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** kehidupan (ID: `keyterm:Life`); harapan (ID: `keyterm:Hope`); selama, lamanya (ID: `keyterm:Always`); kebaikan (ID: `keyterm:Favor`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`)
