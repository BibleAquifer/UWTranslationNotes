...
* **Associated ACAI Concepts:** orang pilihan (ID: `keyterm:Chosen`); Yesus (ID: `person:Jesus.2`); Paulus (ID: `person:Paul`); percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`); kebenaran (ID: `keyterm:Truth`)
...
* **Associated ACAI Concepts:** kehidupan (ID: `keyterm:Life`); harapan (ID: `keyterm:Hope`); janji (ID: `keyterm:Promise`); selama, lamanya (ID: `keyterm:Always`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Titus (ID: `person:Titus`); kebaikan (ID: `keyterm:Favor`); (kepunyaan) bersama (ID: `keyterm:InCommon`); Yesus (ID: `person:Jesus.2`); juruselamat (ID: `keyterm:Savior`); percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`); memperdamaikan (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** suka akan yang baik (ID: `keyterm:LikingWhatIsGood`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); khusus (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** yang baik (ID: `keyterm:Good`); menghujat (ID: `keyterm:Blaspheme`); murni (ID: `keyterm:Pure`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** juruselamat (ID: `keyterm:Savior`); harapan (ID: `keyterm:Hope`); Yesus (ID: `person:Jesus.2`); berbahagialah (ID: `keyterm:Happy`); kemuliaan (ID: `keyterm:Glory`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** kekuasaan (ID: `keyterm:Authority.2`); menasihati (ID: `keyterm:Encourage`); meminta (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** Roh (ID: `deity:HolySpirit`); keselamatan (ID: `keyterm:Salvation`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); belas kasihan (ID: `keyterm:Mercy`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); juruselamat (ID: `keyterm:Savior`)
...
* **Associated ACAI Concepts:** menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); kehidupan (ID: `keyterm:Life`); kebaikan (ID: `keyterm:Favor`); harapan (ID: `keyterm:Hope`); selama, lamanya (ID: `keyterm:Always`)
