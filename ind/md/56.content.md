...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`); Paulus (ID: `person:Paul`); orang pilihan (ID: `keyterm:Chosen`); kebenaran (ID: `keyterm:Truth`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** selama, lamanya (ID: `keyterm:Always`); kehidupan (ID: `keyterm:Life`); Tuhan (ID: `deity:Lord`); janji (ID: `keyterm:Promise`); harapan (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** Titus (ID: `person:Titus`); percaya (ID: `keyterm:Believe`); (kepunyaan) bersama (ID: `keyterm:InCommon`); kebaikan (ID: `keyterm:Favor`); juruselamat (ID: `keyterm:Savior`); Tuhan (ID: `deity:Lord`); memperdamaikan (ID: `keyterm:Peace`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** yang baik (ID: `keyterm:Good`); Tuhan (ID: `deity:Lord`); murni (ID: `keyterm:Pure`); menghujat (ID: `keyterm:Blaspheme`)
...
* **Associated ACAI Concepts:** juruselamat (ID: `keyterm:Savior`); kemuliaan (ID: `keyterm:Glory`); Tuhan (ID: `deity:Lord`); harapan (ID: `keyterm:Hope`); berbahagialah (ID: `keyterm:Happy`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Roh (ID: `deity:HolySpirit`); keselamatan (ID: `keyterm:Salvation`); belas kasihan (ID: `keyterm:Mercy`)
