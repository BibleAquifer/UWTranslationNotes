...
* **Associated ACAI Concepts:** kebenaran (ID: `keyterm:Truth`); Tuhan (ID: `deity:Lord`); Yesus (ID: `person:Jesus.2`); Paulus (ID: `person:Paul`); percaya (ID: `keyterm:Believe`); orang pilihan (ID: `keyterm:Chosen`)
...
* **Associated ACAI Concepts:** harapan (ID: `keyterm:Hope`); kehidupan (ID: `keyterm:Life`); Tuhan (ID: `deity:Lord`); janji (ID: `keyterm:Promise`); selama, lamanya (ID: `keyterm:Always`)
...
* **Associated ACAI Concepts:** Titus (ID: `person:Titus`); (kepunyaan) bersama (ID: `keyterm:InCommon`); juruselamat (ID: `keyterm:Savior`); memperdamaikan (ID: `keyterm:Peace`); Tuhan (ID: `deity:Lord`); kebaikan (ID: `keyterm:Favor`); Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** menghujat (ID: `keyterm:Blaspheme`); Tuhan (ID: `deity:Lord`); yang baik (ID: `keyterm:Good`); murni (ID: `keyterm:Pure`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); yang baik (ID: `keyterm:Good`); juruselamat (ID: `keyterm:Savior`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** keahlian (ID: `keyterm:Ability`); duniawi (ID: `keyterm:Worldly`); kehidupan (ID: `keyterm:Life`); selama, lamanya (ID: `keyterm:Always`)
...
* **Associated ACAI Concepts:** juruselamat (ID: `keyterm:Savior`); harapan (ID: `keyterm:Hope`); berbahagialah (ID: `keyterm:Happy`); Tuhan (ID: `deity:Lord`); Yesus (ID: `person:Jesus.2`); kemuliaan (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** meminta (ID: `keyterm:AskFor`); kekuasaan (ID: `keyterm:Authority.2`); menasihati (ID: `keyterm:Encourage`)
...
* **Associated ACAI Concepts:** ramah (ID: `keyterm:Gentle`); menghujat (ID: `keyterm:Blaspheme`)
...
* **Associated ACAI Concepts:** belas kasihan (ID: `keyterm:Mercy`); Roh (ID: `deity:HolySpirit`); keselamatan (ID: `keyterm:Salvation`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** juruselamat (ID: `keyterm:Savior`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** harapan (ID: `keyterm:Hope`); kehidupan (ID: `keyterm:Life`); kebaikan (ID: `keyterm:Favor`); selama, lamanya (ID: `keyterm:Always`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`)
