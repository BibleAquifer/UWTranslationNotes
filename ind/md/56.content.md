...
* **Associated ACAI Concepts:** kebenaran (ID: `keyterm:Truth`); orang pilihan (ID: `keyterm:Chosen`); percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`); Yesus (ID: `person:Jesus.2`); Paulus (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); janji (ID: `keyterm:Promise`); harapan (ID: `keyterm:Hope`); selama, lamanya (ID: `keyterm:Always`); kehidupan (ID: `keyterm:Life`)
...
* **Associated ACAI Concepts:** Titus (ID: `person:Titus`); (kepunyaan) bersama (ID: `keyterm:InCommon`); percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`); memperdamaikan (ID: `keyterm:Peace`); kebaikan (ID: `keyterm:Favor`); juruselamat (ID: `keyterm:Savior`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** yang baik (ID: `keyterm:Good`); murni (ID: `keyterm:Pure`); Tuhan (ID: `deity:Lord`); menghujat (ID: `keyterm:Blaspheme`)
...
* **Associated ACAI Concepts:** kekuasaan (ID: `keyterm:Authority.2`); meminta (ID: `keyterm:AskFor`); menasihati (ID: `keyterm:Encourage`)
...
* **Associated ACAI Concepts:** menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); belas kasihan (ID: `keyterm:Mercy`); Roh (ID: `deity:HolySpirit`); keselamatan (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); kebaikan (ID: `keyterm:Favor`); harapan (ID: `keyterm:Hope`); selama, lamanya (ID: `keyterm:Always`); kehidupan (ID: `keyterm:Life`)
