...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Paulus (ID: `person:Paul`); kebenaran (ID: `keyterm:Truth`); Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); orang pilihan (ID: `keyterm:Chosen`)
...
* **Associated ACAI Concepts:** juruselamat (ID: `keyterm:Savior`); memberitakan (ID: `keyterm:Proclaim`); Tuhan (ID: `deity:Lord`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** Titus (ID: `person:Titus`); Tuhan (ID: `deity:Lord`); juruselamat (ID: `keyterm:Savior`); memperdamaikan (ID: `keyterm:Peace`); kebaikan (ID: `keyterm:Favor`); Yesus (ID: `person:Jesus.2`); (kepunyaan) bersama (ID: `keyterm:InCommon`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** menghujat (ID: `keyterm:Blaspheme`); murni (ID: `keyterm:Pure`); yang baik (ID: `keyterm:Good`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** juruselamat (ID: `keyterm:Savior`); yang baik (ID: `keyterm:Good`); Tuhan (ID: `deity:Lord`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** juruselamat (ID: `keyterm:Savior`); Tuhan (ID: `deity:Lord`); Yesus (ID: `person:Jesus.2`); harapan (ID: `keyterm:Hope`); kemuliaan (ID: `keyterm:Glory`); berbahagialah (ID: `keyterm:Happy`)
...
* **Associated ACAI Concepts:** menasihati (ID: `keyterm:Encourage`); meminta (ID: `keyterm:AskFor`); kekuasaan (ID: `keyterm:Authority.2`)
...
* **Associated ACAI Concepts:** belas kasihan (ID: `keyterm:Mercy`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); keselamatan (ID: `keyterm:Salvation`); Roh (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); kebaikan (ID: `keyterm:Favor`); kehidupan (ID: `keyterm:Life`); harapan (ID: `keyterm:Hope`); selama, lamanya (ID: `keyterm:Always`)
