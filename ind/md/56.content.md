...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); Paulus (ID: `person:Paul`); Tuhan (ID: `deity:Lord`); kebenaran (ID: `keyterm:Truth`); orang pilihan (ID: `keyterm:Chosen`)
...
* **Associated ACAI Concepts:** Titus (ID: `person:Titus`); memperdamaikan (ID: `keyterm:Peace`); Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); (kepunyaan) bersama (ID: `keyterm:InCommon`); Tuhan (ID: `deity:Lord`); kebaikan (ID: `keyterm:Favor`); juruselamat (ID: `keyterm:Savior`)
...
* **Associated ACAI Concepts:** menghujat (ID: `keyterm:Blaspheme`); Tuhan (ID: `deity:Lord`); murni (ID: `keyterm:Pure`); yang baik (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** juruselamat (ID: `keyterm:Savior`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`); kemuliaan (ID: `keyterm:Glory`); berbahagialah (ID: `keyterm:Happy`); harapan (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** kebaikan (ID: `keyterm:Favor`); kehidupan (ID: `keyterm:Life`); harapan (ID: `keyterm:Hope`); selama, lamanya (ID: `keyterm:Always`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`)
