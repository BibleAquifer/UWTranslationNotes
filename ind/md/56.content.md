...
* **Associated ACAI Concepts:** orang pilihan (ID: `keyterm:Chosen`); Paulus (ID: `person:Paul`); percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`); kebenaran (ID: `keyterm:Truth`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Titus (ID: `person:Titus`); memperdamaikan (ID: `keyterm:Peace`); percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`); juruselamat (ID: `keyterm:Savior`); Yesus (ID: `person:Jesus.2`); kebaikan (ID: `keyterm:Favor`); (kepunyaan) bersama (ID: `keyterm:InCommon`)
...
* **Associated ACAI Concepts:** juruselamat (ID: `keyterm:Savior`); Tuhan (ID: `deity:Lord`); berbahagialah (ID: `keyterm:Happy`); kemuliaan (ID: `keyterm:Glory`); Yesus (ID: `person:Jesus.2`); harapan (ID: `keyterm:Hope`)
