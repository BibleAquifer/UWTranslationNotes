...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); Petrus (ID: `person:Peter`); juruselamat (ID: `keyterm:Savior`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); selama, lamanya (ID: `keyterm:Always`); kerajaan (ID: `keyterm:Kingdom`); juruselamat (ID: `keyterm:Savior`)
...
* **Associated ACAI Concepts:** hati (ID: `keyterm:Heart`); kepenuhan (roh) seperti nabi (ID: `keyterm:Speak`)
...
* **Associated ACAI Concepts:** ditahan di neraka (ID: `keyterm:HoldInTartarus`); berbuat dosa (ID: `keyterm:Sin`); penghakiman (ID: `keyterm:Judgment`); Hell (ID: `place:Hell`); An Angel (ID: `deity:Angel`); pengadilan (ID: `keyterm:CourtCase`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** menentang (ID: `keyterm:Condemn`); Gomora (ID: `place:Gomorrah`); Sodom (ID: `place:Sodom`)
...
* **Associated ACAI Concepts:** Lot (ID: `person:Lot`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); menyelamatkan (ID: `keyterm:Deliver`); tak kenal hukum (ID: `keyterm:Lawless`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); penghakiman (ID: `keyterm:Judgment`); menyelamatkan (ID: `keyterm:Deliver`); pengadilan (ID: `keyterm:CourtCase`)
...
* **Associated ACAI Concepts:** pencemaran (ID: `keyterm:Defilement`); menghujat (ID: `keyterm:Blaspheme`); tubuh (ID: `keyterm:Body.3`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** penghakiman (ID: `keyterm:Judgment`); hujat (ID: `keyterm:Blasphemous`); An Angel (ID: `deity:Angel`); keahlian (ID: `keyterm:Ability`); pengadilan (ID: `keyterm:CourtCase`)
...
* **Associated ACAI Concepts:** Beor (ID: `person:Beor.2`); Bileam (ID: `person:Balaam`); kebenaran (ID: `keyterm:Straightness`); kasihi (ID: `keyterm:Love`); lalim (ID: `keyterm:UnjustDeed`)
...
* **Associated ACAI Concepts:** sia, sia (ID: `keyterm:Worthless`); tubuh (ID: `keyterm:Body.3`); kelakuan (ID: `keyterm:Behavior`)
...
* **Associated ACAI Concepts:** perintah (ID: `keyterm:Commandment`); khusus (ID: `keyterm:Holy`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** Pig (ID: `fauna:Pig`); benar (ID: `keyterm:True`); A Person (ID: `person:GenericPerson`); Dog (ID: `fauna:Dog`); Jackal (ID: `fauna:Jackal`)
...
* **Associated ACAI Concepts:** pikiran (ID: `keyterm:Mind.2`); kekasih (ID: `keyterm:Beloved`); murni (ID: `keyterm:Pure`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); perintah (ID: `keyterm:Commandment`); firman (ID: `keyterm:Word`); juruselamat (ID: `keyterm:Savior`); khusus (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** penghakiman (ID: `keyterm:Judgment`); sorga (ID: `keyterm:Heaven`); pengadilan (ID: `keyterm:CourtCase`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); sorga (ID: `keyterm:Heaven`); roh, roh dunia (ID: `keyterm:FundamentalPrinciples`)
...
* **Associated ACAI Concepts:** menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); janji (ID: `keyterm:Promise`); sorga (ID: `keyterm:Heaven`)
...
* **Associated ACAI Concepts:** memperdamaikan (ID: `keyterm:Peace`); lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); kekasih (ID: `keyterm:Beloved`); tak bernoda (ID: `keyterm:AboveCriticism`)
...
* **Associated ACAI Concepts:** kekasih (ID: `keyterm:Beloved`); Tuhan (ID: `deity:Lord`); Paulus (ID: `person:Paul`); keselamatan (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); kebaikan (ID: `keyterm:Favor`); selama, lamanya (ID: `keyterm:Always`); juruselamat (ID: `keyterm:Savior`); kemuliaan (ID: `keyterm:Glory`)
