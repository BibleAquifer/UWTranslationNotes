...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Petrus (ID: `person:Peter`); juruselamat (ID: `keyterm:Savior`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); pengadilan (ID: `keyterm:CourtCase`); penghakiman (ID: `keyterm:Judgment`); Hell (ID: `place:Hell`); berbuat dosa (ID: `keyterm:Sin`); ditahan di neraka (ID: `keyterm:HoldInTartarus`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** Lot (ID: `person:Lot`); tak kenal hukum (ID: `keyterm:Lawless`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); menyelamatkan (ID: `keyterm:Deliver`)
...
* **Associated ACAI Concepts:** pengadilan (ID: `keyterm:CourtCase`); penghakiman (ID: `keyterm:Judgment`); menyelamatkan (ID: `keyterm:Deliver`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** keahlian (ID: `keyterm:Ability`); menghujat (ID: `keyterm:Blaspheme`); tubuh (ID: `keyterm:Body.3`); pencemaran (ID: `keyterm:Defilement`)
...
* **Associated ACAI Concepts:** hujat (ID: `keyterm:Blasphemous`); pengadilan (ID: `keyterm:CourtCase`); penghakiman (ID: `keyterm:Judgment`); keahlian (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** Beor (ID: `person:Beor.2`); Bileam (ID: `person:Balaam`); kasihi (ID: `keyterm:Love`); kebenaran (ID: `keyterm:Straightness`); lalim (ID: `keyterm:UnjustDeed`)
...
* **Associated ACAI Concepts:** kelakuan (ID: `keyterm:Behavior`); sia, sia (ID: `keyterm:Worthless`); tubuh (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** khusus (ID: `keyterm:Holy`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); perintah (ID: `keyterm:Commandment`)
...
* **Associated ACAI Concepts:** juruselamat (ID: `keyterm:Savior`); Yesus (ID: `person:Jesus.2`); khusus (ID: `keyterm:Holy`); perintah (ID: `keyterm:Commandment`); firman (ID: `keyterm:Word`)
...
* **Associated ACAI Concepts:** lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); kekasih (ID: `keyterm:Beloved`); memperdamaikan (ID: `keyterm:Peace`); tak bernoda (ID: `keyterm:AboveCriticism`)
...
* **Associated ACAI Concepts:** Paulus (ID: `person:Paul`); kekasih (ID: `keyterm:Beloved`); keselamatan (ID: `keyterm:Salvation`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** juruselamat (ID: `keyterm:Savior`); kebaikan (ID: `keyterm:Favor`); Yesus (ID: `person:Jesus.2`); selama, lamanya (ID: `keyterm:Always`); kemuliaan (ID: `keyterm:Glory`)
