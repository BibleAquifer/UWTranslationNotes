...
* **Associated ACAI Concepts:** juruselamat (ID: `keyterm:Savior`); Yesus (ID: `person:Jesus.2`); Petrus (ID: `person:Peter`); percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** penghakiman (ID: `keyterm:Judgment`); berbuat dosa (ID: `keyterm:Sin`); pengadilan (ID: `keyterm:CourtCase`); An Angel (ID: `deity:Angel`); Hell (ID: `place:Hell`); ditahan di neraka (ID: `keyterm:HoldInTartarus`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Lot (ID: `person:Lot`); menyelamatkan (ID: `keyterm:Deliver`); tak kenal hukum (ID: `keyterm:Lawless`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** menghujat (ID: `keyterm:Blaspheme`); tubuh (ID: `keyterm:Body.3`); pencemaran (ID: `keyterm:Defilement`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** penghakiman (ID: `keyterm:Judgment`); keahlian (ID: `keyterm:Ability`); hujat (ID: `keyterm:Blasphemous`); pengadilan (ID: `keyterm:CourtCase`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** Bileam (ID: `person:Balaam`); Beor (ID: `person:Beor.2`); lalim (ID: `keyterm:UnjustDeed`); kebenaran (ID: `keyterm:Straightness`); kasihi (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** kelakuan (ID: `keyterm:Behavior`); tubuh (ID: `keyterm:Body.3`); sia, sia (ID: `keyterm:Worthless`)
...
* **Associated ACAI Concepts:** juruselamat (ID: `keyterm:Savior`); khusus (ID: `keyterm:Holy`); Yesus (ID: `person:Jesus.2`); perintah (ID: `keyterm:Commandment`); firman (ID: `keyterm:Word`)
...
* **Associated ACAI Concepts:** tak bernoda (ID: `keyterm:AboveCriticism`); memperdamaikan (ID: `keyterm:Peace`); lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); kekasih (ID: `keyterm:Beloved`)
