...
* **Associated ACAI Concepts:** Petrus (ID: `person:Peter`); juruselamat (ID: `keyterm:Savior`); Tuhan (ID: `deity:Lord`); Yesus (ID: `person:Jesus.2`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** kerajaan (ID: `keyterm:Kingdom`); juruselamat (ID: `keyterm:Savior`); Yesus (ID: `person:Jesus.2`); selama, lamanya (ID: `keyterm:Always`)
...
* **Associated ACAI Concepts:** berbuat dosa (ID: `keyterm:Sin`); pengadilan (ID: `keyterm:CourtCase`); Tuhan (ID: `deity:Lord`); penghakiman (ID: `keyterm:Judgment`); Hell (ID: `place:Hell`); An Angel (ID: `deity:Angel`); ditahan di neraka (ID: `keyterm:HoldInTartarus`)
...
* **Associated ACAI Concepts:** penghakiman (ID: `keyterm:Judgment`); pengadilan (ID: `keyterm:CourtCase`); Tuhan (ID: `deity:Lord`); menyelamatkan (ID: `keyterm:Deliver`)
...
* **Associated ACAI Concepts:** menghujat (ID: `keyterm:Blaspheme`); keahlian (ID: `keyterm:Ability`); pencemaran (ID: `keyterm:Defilement`); tubuh (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** hujat (ID: `keyterm:Blasphemous`); pengadilan (ID: `keyterm:CourtCase`); keahlian (ID: `keyterm:Ability`); penghakiman (ID: `keyterm:Judgment`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** juruselamat (ID: `keyterm:Savior`); perintah (ID: `keyterm:Commandment`); Yesus (ID: `person:Jesus.2`); firman (ID: `keyterm:Word`); khusus (ID: `keyterm:Holy`)
