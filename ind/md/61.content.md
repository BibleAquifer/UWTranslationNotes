...
* **Associated ACAI Concepts:** menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); percaya (ID: `keyterm:Believe`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`); Petrus (ID: `person:Peter`); juruselamat (ID: `keyterm:Savior`)
...
* **Associated ACAI Concepts:** selama, lamanya (ID: `keyterm:Always`); Yesus (ID: `person:Jesus.2`); kerajaan (ID: `keyterm:Kingdom`); juruselamat (ID: `keyterm:Savior`)
...
* **Associated ACAI Concepts:** pengadilan (ID: `keyterm:CourtCase`); berbuat dosa (ID: `keyterm:Sin`); ditahan di neraka (ID: `keyterm:HoldInTartarus`); Hell (ID: `place:Hell`); Tuhan (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); penghakiman (ID: `keyterm:Judgment`)
...
* **Associated ACAI Concepts:** pengadilan (ID: `keyterm:CourtCase`); penghakiman (ID: `keyterm:Judgment`); Tuhan (ID: `deity:Lord`); menyelamatkan (ID: `keyterm:Deliver`)
...
* **Associated ACAI Concepts:** menghujat (ID: `keyterm:Blaspheme`); keahlian (ID: `keyterm:Ability`); tubuh (ID: `keyterm:Body.3`); pencemaran (ID: `keyterm:Defilement`)
...
* **Associated ACAI Concepts:** pengadilan (ID: `keyterm:CourtCase`); keahlian (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`); hujat (ID: `keyterm:Blasphemous`); penghakiman (ID: `keyterm:Judgment`)
...
* **Associated ACAI Concepts:** Bileam (ID: `person:Balaam`); Beor (ID: `person:Beor.2`); lalim (ID: `keyterm:UnjustDeed`); kasihi (ID: `keyterm:Love`); kebenaran (ID: `keyterm:Straightness`)
...
* **Associated ACAI Concepts:** juruselamat (ID: `keyterm:Savior`); Yesus (ID: `person:Jesus.2`); keahlian (ID: `keyterm:Ability`); pencemaran (ID: `keyterm:Defilement`)
...
* **Associated ACAI Concepts:** firman (ID: `keyterm:Word`); Yesus (ID: `person:Jesus.2`); khusus (ID: `keyterm:Holy`); juruselamat (ID: `keyterm:Savior`); perintah (ID: `keyterm:Commandment`)
...
* **Associated ACAI Concepts:** memperdamaikan (ID: `keyterm:Peace`); kekasih (ID: `keyterm:Beloved`); tak bernoda (ID: `keyterm:AboveCriticism`); lepas atau bebas dari sumpah (ID: `keyterm:Blameless`)
...
* **Associated ACAI Concepts:** kemuliaan (ID: `keyterm:Glory`); selama, lamanya (ID: `keyterm:Always`); Yesus (ID: `person:Jesus.2`); kebaikan (ID: `keyterm:Favor`); juruselamat (ID: `keyterm:Savior`)
