...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); juruselamat (ID: `keyterm:Savior`); Tuhan (ID: `deity:Lord`); Petrus (ID: `person:Peter`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** An Angel (ID: `deity:Angel`); berbuat dosa (ID: `keyterm:Sin`); Hell (ID: `place:Hell`); pengadilan (ID: `keyterm:CourtCase`); Tuhan (ID: `deity:Lord`); penghakiman (ID: `keyterm:Judgment`); ditahan di neraka (ID: `keyterm:HoldInTartarus`)
...
* **Associated ACAI Concepts:** An Angel (ID: `deity:Angel`); hujat (ID: `keyterm:Blasphemous`); keahlian (ID: `keyterm:Ability`); pengadilan (ID: `keyterm:CourtCase`); penghakiman (ID: `keyterm:Judgment`)
...
* **Associated ACAI Concepts:** tubuh (ID: `keyterm:Body.3`); sia, sia (ID: `keyterm:Worthless`); kelakuan (ID: `keyterm:Behavior`)
...
* **Associated ACAI Concepts:** pikiran (ID: `keyterm:Mind.2`); murni (ID: `keyterm:Pure`); kekasih (ID: `keyterm:Beloved`)
...
* **Associated ACAI Concepts:** perintah (ID: `keyterm:Commandment`); khusus (ID: `keyterm:Holy`); juruselamat (ID: `keyterm:Savior`); firman (ID: `keyterm:Word`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** kekasih (ID: `keyterm:Beloved`); lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); memperdamaikan (ID: `keyterm:Peace`); tak bernoda (ID: `keyterm:AboveCriticism`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Paulus (ID: `person:Paul`); keselamatan (ID: `keyterm:Salvation`); kekasih (ID: `keyterm:Beloved`)
...
* **Associated ACAI Concepts:** kemuliaan (ID: `keyterm:Glory`); kebaikan (ID: `keyterm:Favor`); selama, lamanya (ID: `keyterm:Always`); juruselamat (ID: `keyterm:Savior`); Yesus (ID: `person:Jesus.2`)
