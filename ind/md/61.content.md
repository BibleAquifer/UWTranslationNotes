...
* **Associated ACAI Concepts:** Petrus (ID: `person:Peter`); Tuhan (ID: `deity:Lord`); juruselamat (ID: `keyterm:Savior`); percaya (ID: `keyterm:Believe`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); kekasih (ID: `keyterm:Beloved`); kemuliaan (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** Hell (ID: `place:Hell`); An Angel (ID: `deity:Angel`); penghakiman (ID: `keyterm:Judgment`); Tuhan (ID: `deity:Lord`); berbuat dosa (ID: `keyterm:Sin`); pengadilan (ID: `keyterm:CourtCase`); ditahan di neraka (ID: `keyterm:HoldInTartarus`)
...
* **Associated ACAI Concepts:** menentang (ID: `keyterm:Condemn`); Sodom (ID: `place:Sodom`); Gomora (ID: `place:Gomorrah`)
...
* **Associated ACAI Concepts:** pencemaran (ID: `keyterm:Defilement`); tubuh (ID: `keyterm:Body.3`); menghujat (ID: `keyterm:Blaspheme`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** An Angel (ID: `deity:Angel`); penghakiman (ID: `keyterm:Judgment`); pengadilan (ID: `keyterm:CourtCase`); hujat (ID: `keyterm:Blasphemous`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Beor (ID: `person:Beor.2`); Bileam (ID: `person:Balaam`); kasihi (ID: `keyterm:Love`); lalim (ID: `keyterm:UnjustDeed`); kebenaran (ID: `keyterm:Straightness`)
...
* **Associated ACAI Concepts:** keahlian (ID: `keyterm:Ability`); juruselamat (ID: `keyterm:Savior`); pencemaran (ID: `keyterm:Defilement`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** firman (ID: `keyterm:Word`); perintah (ID: `keyterm:Commandment`); khusus (ID: `keyterm:Holy`); juruselamat (ID: `keyterm:Savior`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** janji (ID: `keyterm:Promise`); sorga (ID: `keyterm:Heaven`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); tak bernoda (ID: `keyterm:AboveCriticism`); kekasih (ID: `keyterm:Beloved`); memperdamaikan (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); kekasih (ID: `keyterm:Beloved`); Paulus (ID: `person:Paul`); keselamatan (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** kemuliaan (ID: `keyterm:Glory`); selama, lamanya (ID: `keyterm:Always`); juruselamat (ID: `keyterm:Savior`); kebaikan (ID: `keyterm:Favor`); Yesus (ID: `person:Jesus.2`)
