...
* **Associated ACAI Concepts:** Petrus (ID: `person:Peter`); percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`); juruselamat (ID: `keyterm:Savior`); Yesus (ID: `person:Jesus.2`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`)
...
Pernyataan Penghubung: **Sebab** menunjukkan bahwa dalam 1:16–21 Petrus menjelaskan kepada jemaat mengapa mereka harus mengingat “hal\-hal ini”, yang telah disebutkan dalam 1:5–7. Terjemahan alternatif: “Hal ini karena”
...
* **Associated ACAI Concepts:** Hell (ID: `place:Hell`); penghakiman (ID: `keyterm:Judgment`); berbuat dosa (ID: `keyterm:Sin`); Tuhan (ID: `deity:Lord`); pengadilan (ID: `keyterm:CourtCase`); An Angel (ID: `deity:Angel`); ditahan di neraka (ID: `keyterm:HoldInTartarus`)
...
* **Associated ACAI Concepts:** menyelamatkan (ID: `keyterm:Deliver`); pengadilan (ID: `keyterm:CourtCase`); penghakiman (ID: `keyterm:Judgment`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** hujat (ID: `keyterm:Blasphemous`); penghakiman (ID: `keyterm:Judgment`); keahlian (ID: `keyterm:Ability`); pengadilan (ID: `keyterm:CourtCase`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** Beor (ID: `person:Beor.2`); Bileam (ID: `person:Balaam`); kebenaran (ID: `keyterm:Straightness`); lalim (ID: `keyterm:UnjustDeed`); kasihi (ID: `keyterm:Love`)
...
Pernyataan Penghubung: Di sini, kata ganti **mereka** merujuk kepada guru\-guru palsu yang diperkenalkan dalam 2:1 dan dibahas dalam 2:12–19. Jika akan membantu dalam bahasa Anda, Anda dapat mengungkapkannya secara eksplisit. Terjemahan alternatif: “guru\-guru palsu ini”
...
* **Associated ACAI Concepts:** perintah (ID: `keyterm:Commandment`); firman (ID: `keyterm:Word`); juruselamat (ID: `keyterm:Savior`); Yesus (ID: `person:Jesus.2`); khusus (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** kekasih (ID: `keyterm:Beloved`); tak bernoda (ID: `keyterm:AboveCriticism`); lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); memperdamaikan (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** kekasih (ID: `keyterm:Beloved`); Paulus (ID: `person:Paul`); Tuhan (ID: `deity:Lord`); keselamatan (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** juruselamat (ID: `keyterm:Savior`); kemuliaan (ID: `keyterm:Glory`); selama, lamanya (ID: `keyterm:Always`); Yesus (ID: `person:Jesus.2`); kebaikan (ID: `keyterm:Favor`)
