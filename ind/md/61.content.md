...
* **Associated ACAI Concepts:** menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Tuhan (ID: `deity:Lord`); juruselamat (ID: `keyterm:Savior`); Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); Petrus (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** orang pilihan (ID: `keyterm:Chosen`); tersandung (ID: `keyterm:Stumble`)
...
* **Associated ACAI Concepts:** selama, lamanya (ID: `keyterm:Always`); Yesus (ID: `person:Jesus.2`); juruselamat (ID: `keyterm:Savior`); kerajaan (ID: `keyterm:Kingdom`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); kemuliaan (ID: `keyterm:Glory`); kekasih (ID: `keyterm:Beloved`)
...
* **Associated ACAI Concepts:** An Angel (ID: `deity:Angel`); Tuhan (ID: `deity:Lord`); penghakiman (ID: `keyterm:Judgment`); ditahan di neraka (ID: `keyterm:HoldInTartarus`); Hell (ID: `place:Hell`); berbuat dosa (ID: `keyterm:Sin`); pengadilan (ID: `keyterm:CourtCase`)
...
* **Associated ACAI Concepts:** Gomora (ID: `place:Gomorrah`); Sodom (ID: `place:Sodom`); menentang (ID: `keyterm:Condemn`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); menyelamatkan (ID: `keyterm:Deliver`); pengadilan (ID: `keyterm:CourtCase`); penghakiman (ID: `keyterm:Judgment`)
...
* **Associated ACAI Concepts:** tubuh (ID: `keyterm:Body.3`); pencemaran (ID: `keyterm:Defilement`); menghujat (ID: `keyterm:Blaspheme`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** hujat (ID: `keyterm:Blasphemous`); An Angel (ID: `deity:Angel`); penghakiman (ID: `keyterm:Judgment`); keahlian (ID: `keyterm:Ability`); pengadilan (ID: `keyterm:CourtCase`)
...
* **Associated ACAI Concepts:** Bileam (ID: `person:Balaam`); Beor (ID: `person:Beor.2`); kebenaran (ID: `keyterm:Straightness`); lalim (ID: `keyterm:UnjustDeed`); kasihi (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); juruselamat (ID: `keyterm:Savior`); keahlian (ID: `keyterm:Ability`); pencemaran (ID: `keyterm:Defilement`)
...
* **Associated ACAI Concepts:** perintah (ID: `keyterm:Commandment`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); khusus (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** Pig (ID: `fauna:Pig`); benar (ID: `keyterm:True`); A Person (ID: `person:GenericPerson`); Jackal (ID: `fauna:Jackal`); Dog (ID: `fauna:Dog`)
...
* **Associated ACAI Concepts:** khusus (ID: `keyterm:Holy`); juruselamat (ID: `keyterm:Savior`); firman (ID: `keyterm:Word`); Yesus (ID: `person:Jesus.2`); perintah (ID: `keyterm:Commandment`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); kekasih (ID: `keyterm:Beloved`)
...
* **Associated ACAI Concepts:** lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); tak bernoda (ID: `keyterm:AboveCriticism`); memperdamaikan (ID: `keyterm:Peace`); kekasih (ID: `keyterm:Beloved`)
...
* **Associated ACAI Concepts:** Paulus (ID: `person:Paul`); Tuhan (ID: `deity:Lord`); keselamatan (ID: `keyterm:Salvation`); kekasih (ID: `keyterm:Beloved`)
...
* **Associated ACAI Concepts:** selama, lamanya (ID: `keyterm:Always`); kebaikan (ID: `keyterm:Favor`); kemuliaan (ID: `keyterm:Glory`); juruselamat (ID: `keyterm:Savior`); Yesus (ID: `person:Jesus.2`)
