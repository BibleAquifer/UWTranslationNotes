...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`); juruselamat (ID: `keyterm:Savior`); Petrus (ID: `person:Peter`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** penghakiman (ID: `keyterm:Judgment`); An Angel (ID: `deity:Angel`); ditahan di neraka (ID: `keyterm:HoldInTartarus`); Tuhan (ID: `deity:Lord`); berbuat dosa (ID: `keyterm:Sin`); pengadilan (ID: `keyterm:CourtCase`); Hell (ID: `place:Hell`)
...
* **Associated ACAI Concepts:** keahlian (ID: `keyterm:Ability`); menghujat (ID: `keyterm:Blaspheme`); pencemaran (ID: `keyterm:Defilement`); tubuh (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** hujat (ID: `keyterm:Blasphemous`); keahlian (ID: `keyterm:Ability`); penghakiman (ID: `keyterm:Judgment`); An Angel (ID: `deity:Angel`); pengadilan (ID: `keyterm:CourtCase`)
...
* **Associated ACAI Concepts:** Bileam (ID: `person:Balaam`); Beor (ID: `person:Beor.2`); kasihi (ID: `keyterm:Love`); lalim (ID: `keyterm:UnjustDeed`); kebenaran (ID: `keyterm:Straightness`)
...
* **Associated ACAI Concepts:** keahlian (ID: `keyterm:Ability`); juruselamat (ID: `keyterm:Savior`); Yesus (ID: `person:Jesus.2`); pencemaran (ID: `keyterm:Defilement`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); juruselamat (ID: `keyterm:Savior`); perintah (ID: `keyterm:Commandment`); firman (ID: `keyterm:Word`); khusus (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** tak bernoda (ID: `keyterm:AboveCriticism`); lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); kekasih (ID: `keyterm:Beloved`); memperdamaikan (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** keselamatan (ID: `keyterm:Salvation`); Tuhan (ID: `deity:Lord`); kekasih (ID: `keyterm:Beloved`); Paulus (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); kemuliaan (ID: `keyterm:Glory`); kebaikan (ID: `keyterm:Favor`); juruselamat (ID: `keyterm:Savior`); selama, lamanya (ID: `keyterm:Always`)
