...
* **Associated ACAI Concepts:** Joshua (ID: `person:Joshua.5`); Shealtiel (ID: `person:Shealtiel.2`); Darius (ID: `person:Darius.2`); Jehozadak (ID: `person:Jehozadak`); Haggai (ID: `person:Haggai`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); LORD (ID: `deity:Lord`); Zerubbabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** Zerubbabel (ID: `person:Zerubbabel.2`); Joshua (ID: `person:Joshua.5`); Shealtiel (ID: `person:Shealtiel.2`); Jehozadak (ID: `person:Jehozadak`); LORD (ID: `deity:Lord`); Haggai (ID: `person:Haggai`); Fear (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** Jehozadak (ID: `person:Jehozadak`); Joshua (ID: `person:Joshua.5`); Shealtiel (ID: `person:Shealtiel.2`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); LORD (ID: `deity:Lord`); Zerubbabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Joshua (ID: `person:Joshua.5`); Shealtiel (ID: `person:Shealtiel.2`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Jehozadak (ID: `person:Jehozadak`); Zerubbabel (ID: `person:Zerubbabel.2`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jehozadak (ID: `person:Jehozadak`); Zerubbabel (ID: `person:Zerubbabel.2`); Joshua (ID: `person:Joshua.5`)
...
* **Associated ACAI Concepts:** Holy (ID: `keyterm:Holy`); Wine (ID: `realia:Wine`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Vine (ID: `flora:Vine`); Stew (ID: `realia:Stew`)
...
* **Associated ACAI Concepts:** Bless (ID: `keyterm:Bless`); Barley (ID: `flora:Barley`); Olive Tree (ID: `flora:OliveTree`); Pomegranate (ID: `flora:Pomegranate`); Coriander (ID: `flora:Coriander`); Fig (ID: `flora:Fig`); Vine (ID: `flora:Vine`)
