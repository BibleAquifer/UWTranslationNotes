...
* **Associated ACAI Concepts:** Darius (ID: `person:Darius.2`); Joshua (ID: `person:Joshua.5`); Jehozadak (ID: `person:Jehozadak`); Haggai (ID: `person:Haggai`); Shealtiel (ID: `person:Shealtiel.2`); LORD (ID: `deity:Lord`); Zerubbabel (ID: `person:Zerubbabel.2`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** Zerubbabel (ID: `person:Zerubbabel.2`); Joshua (ID: `person:Joshua.5`); Jehozadak (ID: `person:Jehozadak`); LORD (ID: `deity:Lord`); Haggai (ID: `person:Haggai`); Shealtiel (ID: `person:Shealtiel.2`); Fear (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** Jehozadak (ID: `person:Jehozadak`); Joshua (ID: `person:Joshua.5`); LORD (ID: `deity:Lord`); Shealtiel (ID: `person:Shealtiel.2`); Zerubbabel (ID: `person:Zerubbabel.2`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Joshua (ID: `person:Joshua.5`); Jehozadak (ID: `person:Jehozadak`); Shealtiel (ID: `person:Shealtiel.2`); Zerubbabel (ID: `person:Zerubbabel.2`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Haggai (ID: `person:Haggai`); Darius (ID: `person:Darius.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Holy (ID: `keyterm:Holy`); Vine (ID: `flora:Vine`); Olive Oil (ID: `realia:OliveOil`); Stew (ID: `realia:Stew`); Anointing Oil (ID: `realia:AnointingOil`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Bless (ID: `keyterm:Bless`); Pomegranate (ID: `flora:Pomegranate`); Vine (ID: `flora:Vine`); Olive Tree (ID: `flora:OliveTree`); Barley (ID: `flora:Barley`); Coriander (ID: `flora:Coriander`); Fig (ID: `flora:Fig`)
