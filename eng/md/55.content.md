...
## 2 Timothy - Introduction (id: en_tn_2TI_s7fk)
...
Paul always uses the first\-person plural to refer to both himself and Timothy, and he often includes other believers as well. So, you should always use the inclusive form of the first\-person plural in your translation if your language marks that distinction. (See: Exclusive and Inclusive ‘We’)
...
* **Associated Passages:** 2 Timothy 0:0
...
## 2 Timothy - Chapter 1 Introduction (id: en_tn_2TI_p5lf)

2 Timothy 1 Chapter Introduction
================================
...
In 1:12 and 1:14, Paul refers to a “deposit.” These two uses of the word “deposit” can be understood in two ways:
...
## 2 Timothy 1:5 (#2) (id: en_tn_2TI_vgz2)
...
**"of the sincere faith in you, which dwelled first in your grandmother Lois and your mother Eunice, and I am persuaded that {it is} also in you"**
...
## 2 Timothy 1:5 (#3) (id: 247344)

**τῆς ἐν σοὶ ἀνυποκρίτου πίστεως, ἥτις ἐνῴκησεν πρῶτον**

**"of the sincere faith in you, which dwelled first"**
...
## 2 Timothy - Chapter 2 Introduction (id: en_tn_2TI_k3zn)

2 Timothy 2 Chapter Introduction
================================
...
In 2:11–13, Paul either quotes a poetic hymn or composes his own poetry. Because these verses are poetry, the ULT sets each line farther to the right than the rest of the text to make it easier to distinguish them from prose. Consider how you might express these verses as poetry in your language.
...
* **Associated Passages:** 2 Timothy 2:0
* **Associated Articles:** Biblical Imagery — Extended Metaphors (ID: `33272@UWTranslationNotes`); Poetry (ID: `33422@UWTranslationNotes`)
...
* **Associated Passages:** 2 Timothy 2:11-13
...
## 2 Timothy 2:14 (#3) (id: en_tn_2TI_p051)

**διαμαρτυρόμενος ἐνώπιον τοῦ Θεοῦ**

**"declaring before God"**
...
**"foolish and ignorant controversies"**
...
## 2 Timothy - Chapter 3 Introduction (id: en_tn_2TI_k2cr)

2 Timothy 3 Chapter Introduction
================================
...
* **Associated Passages:** 2 Timothy 3:0
* **Associated Articles:** Metaphor (ID: `33292@UWTranslationNotes`)
...
* **Associated Passages:** 2 Timothy 3:10-11
* **Associated Articles:** Abstract Nouns (ID: `33257@UWTranslationNotes`)
...
**"all the ones wanting to live godly in Christ Jesus will be persecuted"**
...
## 2 Timothy - Chapter 4 Introduction (id: en_tn_2TI_k2xa)

2 Timothy 4 Chapter Introduction
================================
...
* **Associated Passages:** 2 Timothy 4:0
* **Associated Articles:** Metaphor (ID: `33292@UWTranslationNotes`)


## 2 Timothy 4:1 (#1) (id: en_tn_2TI_eh3x)
...
**"I declare before God and Christ Jesus, the one being about to judge living and dead, and by his appearing and his kingdom"**
...
## 2 Timothy 4:19 (#1) (id: en_tn_2TI_tasz)
...
## 2 Timothy 4:21 (#3) (id: en_tn_2TI_dgqi)
