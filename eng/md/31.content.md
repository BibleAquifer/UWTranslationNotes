...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Joseph (ID: `person:Joseph.10`); Edom (ID: `place:Edom`); LORD (ID: `deity:Lord`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** Ephraim (ID: `person:Ephraim`); Philistines (ID: `group:Philistine`); Benjamin (ID: `person:Benjamin`); Shephelah (ID: `place:Shephelah`); Gilead (ID: `place:Gilead`); Philistia (ID: `place:Philistine`); Dispossess (ID: `keyterm:Dispossess`); Negev (ID: `place:Negeb`); Mount Esau (ID: `place:EsauMount`); Tribe of Ephraim (ID: `group:Ephraim`); Samaria (ID: `place:Samaria`); Tribe of Benjamin (ID: `group:Benjamin`)
...
* **Associated ACAI Concepts:** Sardis (ID: `place:Sardis`); Israel (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); Zarephath (ID: `place:Zarephath`); Canaanites (ID: `group:Canaan`); Negev (ID: `place:Negeb`); Canaan (ID: `place:Canaan`); Jerusalem (ID: `place:Jerusalem`)
