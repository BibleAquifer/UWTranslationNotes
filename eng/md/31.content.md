...
1. Yahweh will judge Edom (1:1–16\)
    ...
    1. Yahweh will destroy Edom (1:1–9\)
        2. Why Yahweh will destroy Edom (1:10–14\)
...
* **Associated Passages:** Obadiah 0:0
...
**"I am making you small among the nations, you are extremely despised"**
...
**"If you make yourself high like the eagle, even if your nest is set between the stars"**
...
**"If thieves came to you, and plunderers by night"**
...
* **Associated ACAI Concepts:** Mount Esau (ID: `place:EsauMount`); Understanding (ID: `keyterm:Understanding`); LORD (ID: `deity:Lord`); Edom (ID: `place:Edom`)
...
**"strangers took captive his wealth, and foreigners entered"**
...
**"in the day of their calamity \& in the day of his calamity \& in the day of his calamity"**
...
**"their calamity \& his calamity \& his calamity"**
...
**"For the day of Yahweh is near upon all the nations. According to what you have done, it will be done to you; your recompense will return on your own head"**
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`); Joseph (ID: `person:Joseph.10`); Edom (ID: `place:Edom`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); Mount Esau (ID: `place:EsauMount`); Gilead (ID: `place:Gilead`); Negev (ID: `place:Negeb`); Philistia (ID: `place:Philistine`); Philistines (ID: `group:Philistine`); Shephelah (ID: `place:Shephelah`); Samaria (ID: `place:Samaria`); Benjamin (ID: `person:Benjamin`); Tribe of Ephraim (ID: `group:Ephraim`); Tribe of Benjamin (ID: `group:Benjamin`); Ephraim (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); Canaanites (ID: `group:Canaan`); Negev (ID: `place:Negeb`); Israel (ID: `person:Israel`); Jerusalem (ID: `place:Jerusalem`); Canaan (ID: `place:Canaan`); Sardis (ID: `place:Sardis`); Zarephath (ID: `place:Zarephath`)
