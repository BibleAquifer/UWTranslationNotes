...
* **Associated ACAI Concepts:** Edom (ID: `place:Edom`); Joseph (ID: `person:Joseph.10`); Edomites (ID: `group:Edom`); LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Philistia (ID: `place:Philistine`); Shephelah (ID: `place:Shephelah`); Dispossess (ID: `keyterm:Dispossess`); Ephraim (ID: `person:Ephraim`); Gilead (ID: `place:Gilead`); Samaria (ID: `place:Samaria`); Philistines (ID: `group:Philistine`); Tribe of Ephraim (ID: `group:Ephraim`); Negev (ID: `place:Negeb`); Mount Esau (ID: `place:EsauMount`); Tribe of Benjamin (ID: `group:Benjamin`); Benjamin (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); Canaanites (ID: `group:Canaan`); Jerusalem (ID: `place:Jerusalem`); Canaan (ID: `place:Canaan`); Sardis (ID: `place:Sardis`); Zarephath (ID: `place:Zarephath`); Negev (ID: `place:Negeb`); Israel (ID: `person:Israel`)
