...
* **Associated ACAI Concepts:** Understanding (ID: `keyterm:Understanding`); Edom (ID: `place:Edom`); Mount Esau (ID: `place:EsauMount`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Negev (ID: `place:Negeb`); Philistines (ID: `group:Philistine`); Tribe of Benjamin (ID: `group:Benjamin`); Tribe of Ephraim (ID: `group:Ephraim`); Ephraim (ID: `person:Ephraim`); Mount Esau (ID: `place:EsauMount`); Shephelah (ID: `place:Shephelah`); Dispossess (ID: `keyterm:Dispossess`); Philistia (ID: `place:Philistine`); Gilead (ID: `place:Gilead`); Benjamin (ID: `person:Benjamin`); Samaria (ID: `place:Samaria`)
...
* **Associated ACAI Concepts:** Negev (ID: `place:Negeb`); Sardis (ID: `place:Sardis`); Zarephath (ID: `place:Zarephath`); Israel (ID: `person:Israel`); Canaan (ID: `place:Canaan`); Dispossess (ID: `keyterm:Dispossess`); Canaanites (ID: `group:Canaan`); Jerusalem (ID: `place:Jerusalem`)
