...
* **Associated ACAI Concepts:** Mount Esau (ID: `place:EsauMount`); LORD (ID: `deity:Lord`); Edom (ID: `place:Edom`); Understanding (ID: `keyterm:Understanding`)
...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); LORD (ID: `deity:Lord`); Joseph (ID: `person:Joseph.10`); Edom (ID: `place:Edom`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Shephelah (ID: `place:Shephelah`); Philistines (ID: `group:Philistine`); Benjamin (ID: `person:Benjamin`); Dispossess (ID: `keyterm:Dispossess`); Negev (ID: `place:Negeb`); Mount Esau (ID: `place:EsauMount`); Gilead (ID: `place:Gilead`); Ephraim (ID: `person:Ephraim`); Samaria (ID: `place:Samaria`); Tribe of Benjamin (ID: `group:Benjamin`); Tribe of Ephraim (ID: `group:Ephraim`); Philistia (ID: `place:Philistine`)
...
* **Associated ACAI Concepts:** Canaanites (ID: `group:Canaan`); Sardis (ID: `place:Sardis`); Dispossess (ID: `keyterm:Dispossess`); Negev (ID: `place:Negeb`); Zarephath (ID: `place:Zarephath`); Canaan (ID: `place:Canaan`); Jerusalem (ID: `place:Jerusalem`); Israel (ID: `person:Israel`)
