...
* **Associated ACAI Concepts:** Joseph (ID: `person:Joseph.10`); Edom (ID: `place:Edom`); Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** Gilead (ID: `place:Gilead`); Shephelah (ID: `place:Shephelah`); Benjamin (ID: `person:Benjamin`); Ephraim (ID: `person:Ephraim`); Mount Esau (ID: `place:EsauMount`); Samaria (ID: `place:Samaria`); Philistines (ID: `group:Philistine`); Dispossess (ID: `keyterm:Dispossess`); Tribe of Ephraim (ID: `group:Ephraim`); Tribe of Benjamin (ID: `group:Benjamin`); Philistia (ID: `place:Philistine`); Negev (ID: `place:Negeb`)
...
* **Associated ACAI Concepts:** Canaan (ID: `place:Canaan`); Jerusalem (ID: `place:Jerusalem`); Zarephath (ID: `place:Zarephath`); Israel (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); Canaanites (ID: `group:Canaan`); Sardis (ID: `place:Sardis`); Negev (ID: `place:Negeb`)
