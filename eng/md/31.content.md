...
* **Associated ACAI Concepts:** Joseph (ID: `person:Joseph.10`); Edom (ID: `place:Edom`); LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** Ephraim (ID: `person:Ephraim`); Samaria (ID: `place:Samaria`); Negev (ID: `place:Negeb`); Tribe of Ephraim (ID: `group:Ephraim`); Benjamin (ID: `person:Benjamin`); Philistines (ID: `group:Philistine`); Tribe of Benjamin (ID: `group:Benjamin`); Gilead (ID: `place:Gilead`); Shephelah (ID: `place:Shephelah`); Mount Esau (ID: `place:EsauMount`); Philistia (ID: `place:Philistine`); Dispossess (ID: `keyterm:Dispossess`)
...
* **Associated ACAI Concepts:** Zarephath (ID: `place:Zarephath`); Israel (ID: `person:Israel`); Sardis (ID: `place:Sardis`); Canaanites (ID: `group:Canaan`); Dispossess (ID: `keyterm:Dispossess`); Jerusalem (ID: `place:Jerusalem`); Negev (ID: `place:Negeb`); Canaan (ID: `place:Canaan`)
