...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Joseph (ID: `person:Joseph.10`); Edom (ID: `place:Edom`); Edomites (ID: `group:Edom`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Gilead (ID: `place:Gilead`); Shephelah (ID: `place:Shephelah`); Tribe of Benjamin (ID: `group:Benjamin`); Tribe of Ephraim (ID: `group:Ephraim`); Philistia (ID: `place:Philistine`); Negev (ID: `place:Negeb`); Benjamin (ID: `person:Benjamin`); Mount Esau (ID: `place:EsauMount`); Dispossess (ID: `keyterm:Dispossess`); Ephraim (ID: `person:Ephraim`); Philistines (ID: `group:Philistine`); Samaria (ID: `place:Samaria`)
...
* **Associated ACAI Concepts:** Canaan (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); Zarephath (ID: `place:Zarephath`); Sardis (ID: `place:Sardis`); Negev (ID: `place:Negeb`); Jerusalem (ID: `place:Jerusalem`); Dispossess (ID: `keyterm:Dispossess`); Israel (ID: `person:Israel`)
