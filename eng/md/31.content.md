...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Edom (ID: `place:Edom`); Edomites (ID: `group:Edom`); Joseph (ID: `person:Joseph.10`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Samaria (ID: `place:Samaria`); Dispossess (ID: `keyterm:Dispossess`); Tribe of Benjamin (ID: `group:Benjamin`); Gilead (ID: `place:Gilead`); Negev (ID: `place:Negeb`); Benjamin (ID: `person:Benjamin`); Ephraim (ID: `person:Ephraim`); Shephelah (ID: `place:Shephelah`); Tribe of Ephraim (ID: `group:Ephraim`); Mount Esau (ID: `place:EsauMount`); Philistines (ID: `group:Philistine`); Philistia (ID: `place:Philistine`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); Negev (ID: `place:Negeb`); Israel (ID: `person:Israel`); Zarephath (ID: `place:Zarephath`); Canaan (ID: `place:Canaan`); Jerusalem (ID: `place:Jerusalem`); Canaanites (ID: `group:Canaan`); Sardis (ID: `place:Sardis`)
