...
* **Associated ACAI Concepts:** Edomites (ID: `group:Edom`); Edom (ID: `place:Edom`); LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Joseph (ID: `person:Joseph.10`)
...
* **Associated ACAI Concepts:** Tribe of Benjamin (ID: `group:Benjamin`); Negev (ID: `place:Negeb`); Samaria (ID: `place:Samaria`); Shephelah (ID: `place:Shephelah`); Mount Esau (ID: `place:EsauMount`); Tribe of Ephraim (ID: `group:Ephraim`); Gilead (ID: `place:Gilead`); Philistia (ID: `place:Philistine`); Ephraim (ID: `person:Ephraim`); Philistines (ID: `group:Philistine`); Benjamin (ID: `person:Benjamin`); Dispossess (ID: `keyterm:Dispossess`)
...
* **Associated ACAI Concepts:** Canaanites (ID: `group:Canaan`); Zarephath (ID: `place:Zarephath`); Negev (ID: `place:Negeb`); Canaan (ID: `place:Canaan`); Sardis (ID: `place:Sardis`); Israel (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); Jerusalem (ID: `place:Jerusalem`)
