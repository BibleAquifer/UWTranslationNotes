...
* **Associated ACAI Concepts:** Edom (ID: `place:Edom`); Mount Esau (ID: `place:EsauMount`); LORD (ID: `deity:Lord`); Understanding (ID: `keyterm:Understanding`)
...
* **Associated ACAI Concepts:** Joseph (ID: `person:Joseph.10`); Edom (ID: `place:Edom`); Israel (ID: `person:Israel`); Edomites (ID: `group:Edom`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Ephraim (ID: `person:Ephraim`); Mount Esau (ID: `place:EsauMount`); Philistia (ID: `place:Philistine`); Samaria (ID: `place:Samaria`); Negev (ID: `place:Negeb`); Shephelah (ID: `place:Shephelah`); Dispossess (ID: `keyterm:Dispossess`); Tribe of Benjamin (ID: `group:Benjamin`); Gilead (ID: `place:Gilead`); Philistines (ID: `group:Philistine`); Benjamin (ID: `person:Benjamin`); Tribe of Ephraim (ID: `group:Ephraim`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); Negev (ID: `place:Negeb`); Jerusalem (ID: `place:Jerusalem`); Canaanites (ID: `group:Canaan`); Zarephath (ID: `place:Zarephath`); Israel (ID: `person:Israel`); Sardis (ID: `place:Sardis`); Canaan (ID: `place:Canaan`)
