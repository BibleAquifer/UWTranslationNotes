...
* **Associated ACAI Concepts:** Benjamin (ID: `person:Benjamin`); Ephraim (ID: `person:Ephraim`); Dispossess (ID: `keyterm:Dispossess`); Gilead (ID: `place:Gilead`); Samaria (ID: `place:Samaria`); Mount Esau (ID: `place:EsauMount`); Philistines (ID: `group:Philistine`); Negev (ID: `place:Negeb`); Philistia (ID: `place:Philistine`); Shephelah (ID: `place:Shephelah`); Tribe of Benjamin (ID: `group:Benjamin`); Tribe of Ephraim (ID: `group:Ephraim`)
...
* **Associated ACAI Concepts:** Canaan (ID: `place:Canaan`); Dispossess (ID: `keyterm:Dispossess`); Zarephath (ID: `place:Zarephath`); Israel (ID: `person:Israel`); Sardis (ID: `place:Sardis`); Negev (ID: `place:Negeb`); Jerusalem (ID: `place:Jerusalem`); Canaanites (ID: `group:Canaan`)
