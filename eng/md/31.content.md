...
* **Associated ACAI Concepts:** Joseph (ID: `person:Joseph.10`); LORD (ID: `deity:Lord`); Edomites (ID: `group:Edom`); Edom (ID: `place:Edom`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Dispossess (ID: `keyterm:Dispossess`); Negev (ID: `place:Negeb`); Philistines (ID: `group:Philistine`); Benjamin (ID: `person:Benjamin`); Tribe of Ephraim (ID: `group:Ephraim`); Tribe of Benjamin (ID: `group:Benjamin`); Philistia (ID: `place:Philistine`); Gilead (ID: `place:Gilead`); Ephraim (ID: `person:Ephraim`); Mount Esau (ID: `place:EsauMount`); Shephelah (ID: `place:Shephelah`); Samaria (ID: `place:Samaria`)
...
* **Associated ACAI Concepts:** Negev (ID: `place:Negeb`); Zarephath (ID: `place:Zarephath`); Jerusalem (ID: `place:Jerusalem`); Canaan (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); Sardis (ID: `place:Sardis`); Dispossess (ID: `keyterm:Dispossess`); Israel (ID: `person:Israel`)
