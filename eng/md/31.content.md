...
* **Associated ACAI Concepts:** Ephraim (ID: `person:Ephraim`); Tribe of Ephraim (ID: `group:Ephraim`); Gilead (ID: `place:Gilead`); Mount Esau (ID: `place:EsauMount`); Shephelah (ID: `place:Shephelah`); Dispossess (ID: `keyterm:Dispossess`); Tribe of Benjamin (ID: `group:Benjamin`); Philistines (ID: `group:Philistine`); Philistia (ID: `place:Philistine`); Samaria (ID: `place:Samaria`); Negev (ID: `place:Negeb`); Benjamin (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Dispossess (ID: `keyterm:Dispossess`); Israel (ID: `person:Israel`); Sardis (ID: `place:Sardis`); Canaan (ID: `place:Canaan`); Negev (ID: `place:Negeb`); Zarephath (ID: `place:Zarephath`); Canaanites (ID: `group:Canaan`)
