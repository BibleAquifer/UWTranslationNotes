...
## James - Introduction (id: en_tn_JAS_exs3)
...
Paul taught in Romans that Christians are justified by faith and not by works. James seems to teach that Christians are justified by works. This could be confusing. However, a better understanding of what Paul and James each taught shows that they actually agree with one another. Both of them taught that a person needs faith in order to be justified. They both also taught that true faith would lead a person to do good works. Paul and James taught about these things in different ways because they had different audiences who needed to know different things about being justified. James wrote primarily to Jewish Christians, while Paul wrote to communities in which there were many Gentile Christians. (See: \[\[rc://*/tw/dict/bible/kt/justice]] and \[\[rc://*/tw/dict/bible/kt/faith]])
...
See the introduction to chapter 2 for a discussion of one important textual issue in this book.

* **Associated Passages:** James 0:0
* **Associated Articles:** How to Translate Names (ID: `33391@UWTranslationNotes`)


## James - Chapter 1 Introduction (id: en_tn_JAS_pz2q)

James 1 Chapter Introduction
============================
...
Here, **trial** could mean one of two things. See the discussion of the word in the introduction to this chapter. James may actually want his readers to hear both senses in this case, as this verse is making a transition from a discussion of testing into a discussion of temptation. (1\) The word **trial** could mean the same thing as in 1:2–3, where it describes the “testing” of “faith.” The reading of UST expresses this interpretation. (2\) The word could refer to being tempted, that is, being led by one’s desires to do something wrong, which James discusses in the following verses. Alternate translation: \[resists temptation]
...
* **Associated Articles:** Sentence Types (ID: `33312@UWTranslationNotes`)
...
The word translated as **religious** could refer to a pattern of behavior rather than to participation in worship activities. Alternate translation: \[thinks that he is honoring God by his actions]
...
* **Associated ACAI Concepts:** Clean (ID: `keyterm:Clean`); Above Criticism (ID: `keyterm:AboveCriticism`); LORD (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Undefiled (ID: `keyterm:Undefiled`)
...
## James - Chapter 2 Introduction (id: en_tn_JAS_f5zd)

James 2 Chapter Introduction
============================
...
* **Associated Passages:** James 2:0
* **Associated Articles:** Assumed Knowledge and Implicit Information (ID: `33273@UWTranslationNotes`); Textual Variants (ID: `33405@UWTranslationNotes`)
...
* **Associated ACAI Concepts:** Promise (ID: `keyterm:Promise`); Chosen (ID: `keyterm:Chosen`); Kingdom (ID: `keyterm:Kingdom`); Beloved (ID: `keyterm:Beloved`); Believe (ID: `keyterm:Believe`); LORD (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Love (ID: `keyterm:Love`)
...
The word that is translated as **themselves** here is the same word that is translated **they** in the next verse. It is effectively the subject of a new independent clause, so you could translate this as two sentences. Alternate translation: \[Do not the rich overpower you? Do they not drag you into court]
...
* **Associated ACAI Concepts:** Law (ID: `keyterm:Law`); Fornication (ID: `keyterm:Fornication`)
...
The word translated as **mercy** can also refer to compassion. Since James is referring in this context to following the command to love others, that is likely what it means here. Alternate translation: \[those who have not acted compassionately towards others]
...
## James 2:18 (#2) (id: 260040)

**ἀλλ’ ἐρεῖ τις, σὺ πίστιν ἔχεις, κἀγὼ ἔργα ἔχω**

**"But someone will say, “You have faith, and I have works"**

See the discussion of this sentence in the introduction to this chapter. If it would be helpful to your readers, you could indicate more explicitly what this statement means. (UST explains the implications even further than is suggested here.) Alternate translation: \[But someone may try to reassure you that you nevertheless have faith, while I, James, have works]
...
## James 2:18 (#1) (id: 260039)

**ἀλλ’ ἐρεῖ τις, σὺ πίστιν ἔχεις, κἀγὼ ἔργα ἔχω**

**"But someone will say, “You have faith, and I have works"**

See the discussion of this sentence in the Introduction to this chapter. You may want to turn the direct quotation into an indirect quotation to help your readers understand that the **You** who is being addressed is the same “one of you” as in 2:16 and that when James says **I**, he is referring to himself. Alternate translation: \[But someone may tell you that you have faith and I have works]
...
## James 2:19 (#1) (id: 260049)

**σὺ πιστεύεις ὅτι εἷς ἐστιν ὁ Θεός**

**"You believe that God is one"**

The verb translated as **believe** comes from the same root as the word translated as “faith.” It may be helpful to your readers to show in your translation that James is continuing to speak to the same person as in the previous verse. Alternate translation: \[You have faith that God is one]
...
## James 2:20 (#3) (id: en_tn_JAS_j151)
...
## James 2:20 (#7) (id: 260059)

**ἡ πίστις χωρὶς τῶν ἔργων ἀργή ἐστιν**

**"the faith without the works is idle"**

See the discussion of textual issues at the end of the introduction to this chapter to decide whether to use this reading in your translation or a different reading, \[faith without works is dead.] The note below discusses a translation issue in that reading, for those who decide to use it.
...
* **Associated ACAI Concepts:** To Cause to Happen (ID: `keyterm:Happen`); Written (ID: `keyterm:Scripture`); Abraham (ID: `person:Abraham`); Believe (ID: `keyterm:Believe`); LORD (ID: `deity:Lord`); Be (Or Show Oneself) Just (ID: `keyterm:Just`)

## James 2:23 (#4) (id: 260075)
...
## James 2:26 (#2) (id: 260089)

**τὸ σῶμα χωρὶς πνεύματος νεκρόν ἐστιν**

**"the body without the spirit is dead"**

The word translated as **spirit** can also mean “breath.” Alternate translation: \[a body that does not have the breath of life in it is dead]

* **Associated Passages:** James 2:26

* **Associated ACAI Concepts:** Believe (ID: `keyterm:Believe`); Body (ID: `keyterm:Body.3`); Spirit (ID: `keyterm:Spirit.2`)

## James - Chapter 3 Introduction (id: en_tn_JAS_py3p)

James 3 Chapter Introduction
============================
...
2. Worldly wisdom and heavenly wisdom contrasted (3:13–18\)
...
* **Associated Passages:** James 3:0
* **Associated Articles:** Metaphor (ID: `33292@UWTranslationNotes`)


## James 3:1 (#2) (id: 260093)
...
* **Associated ACAI Concepts:** Hell (ID: `place:Hell`); Gehenna (ID: `keyterm:Gehenna`); Ability (ID: `keyterm:Ability`); Unjust Deed (ID: `keyterm:UnjustDeed`); Body (ID: `keyterm:Body.3`)

## James 3:6 (#8) (id: 260134)
...
## James 3:11 (#3) (id: en_tn_JAS_j221)
...
## James 3:12 (#8) (id: en_tn_JAS_jubc)
...
* **Associated ACAI Concepts:** Gentle (ID: `keyterm:Gentle`); Unhypocritical (ID: `keyterm:Unhypocritical`); Pure (ID: `keyterm:Pure`); Good (ID: `keyterm:Good`); Mercy (ID: `keyterm:Mercy`); Make Peace (ID: `keyterm:Peace`)

## James 3:17 (#1) (id: 260200)
...
## James - Chapter 4 Introduction (id: en_tn_JAS_r6vv)

James 4 Chapter Introduction
============================
...
Writers in the Bible often speak of adultery as a metaphor for people who say they love God but do things that God hates. James uses the same metaphor in 4:4\. (See: Metaphor and \[\[rc://\*/tw/dict/bible/kt/godly]])

* **Associated Passages:** James 4:0
* **Associated Articles:** Metaphor (ID: `33292@UWTranslationNotes`)


## James 4:1 (#4) (id: 260210)
...
In both of these sentences, James is using the word translated as **and** to introduce a contrast between the first and second clauses. Alternate translation: \[You covet, but you do not have. You kill and envy, but you are not able to obtain]
...
## James 4:3 (#1) (id: 260221)

**αἰτεῖτε καὶ οὐ λαμβάνετε**

**"You ask and you do not receive"**

James is using the word translated as **and** to introduce a contrast between these two clauses. Alternate translation: \[You ask but you do not receive]
...
## James 4:7 (#3) (id: 260248)

**ἀντίστητε δὲ τῷ διαβόλῳ, καὶ φεύξεται ἀφ’ ὑμῶν**

**"But resist the devil, and he will flee from you"**

James is using the word translated as **and** to describe a result. Alternate translation: \[But resist the devil. If you do, then he will flee from you]
...
## James 4:8 (#1) (id: 260251)

**ἐγγίσατε τῷ Θεῷ, καὶ ἐγγιεῖ ὑμῖν**

**"Come near to God and he will come near to you"**

James is using the word translated as **and** to describe a result. Alternate translation: \[If you come near to God, then he will come near to you]
...
## James 4:10 (#1) (id: 260268)

**ταπεινώθητε ἐνώπιον Κυρίου, καὶ ὑψώσει ὑμᾶς**

**"Be humbled before the Lord, and he will lift you up"**

James is using the word translated as **and** to describe a result. Alternate translation: \[If you are humbled before the Lord, then he will lift you up]
...
## James 4:16 (#1) (id: 260295)

**καυχᾶσθε ἐν ταῖς ἀλαζονίαις ὑμῶν. πᾶσα καύχησις τοιαύτη πονηρά ἐστιν**

**"you are boasting in your pretensions. All such boasting is evil"**
...
## James - Chapter 5 Introduction (id: en_tn_JAS_ud8q)

James 5 Chapter Introduction
============================
...
* **Associated Passages:** James 5:0


## James 5:1 (#2) (id: en_tn_JAS_j293)
...
## James 5:5 (#1) (id: 260327)

**ἐτρυφήσατε ἐπὶ τῆς γῆς. καὶ ἐσπαταλήσατε**

**"You have lived luxuriously on the earth and have lived self\-indulgently"**
...
## James 5:5 (#2) (id: 260328)

**ἐθρέψατε τὰς καρδίας ὑμῶν ἐν ἡμέρᾳ σφαγῆς**

**"You have fattened your hearts in a day of slaughter"**

James is speaking of these rich people as if they were cattle that had been fed luxuriously on grain so they would become **fattened** for **slaughter** as banqueting food. In this case the banquet is not a positive image, as it often is elsewhere when it describes God’s future reign. Alternate translation: \[Your self\-indulgence has made you subject to harsh judgment]
...
* **Associated ACAI Concepts:** Salvation (ID: `keyterm:Salvation`); Forgive (ID: `keyterm:Forgive`); Pray (ID: `keyterm:Pray`); Believe (ID: `keyterm:Believe`); To Sin (ID: `keyterm:Sin`); LORD (ID: `deity:Lord`)

## James 5:15 (#1) (id: 260375)
...
## James 5:15 (#2) (id: 260376)

**ἡ εὐχὴ τῆς πίστεως σώσει τὸν κάμνοντα**

**"the prayer of the faith will save the sick"**

James is using the word translated as **save** in one of its senses to mean “heal.” (He uses a more specific word to mean “healed” in the next verse.) Alternate translation: \[the prayer that is offered in faith will heal the sick]
...
## James 5:16 (#3) (id: en_tn_JAS_j332)
