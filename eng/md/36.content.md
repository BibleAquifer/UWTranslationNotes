...
* **Associated ACAI Concepts:** Hezekiah (ID: `person:Hezekiah.4`); Zephaniah (ID: `person:Zephaniah.3`); Amariah (ID: `person:Amariah.9`); Cushi (ID: `person:Cushi`); Gedaliah (ID: `person:Gedaliah.3`); Josiah (ID: `person:Josiah`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Amon (ID: `person:Amon.3`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Judah (ID: `person:Judah.4`); Baal (ID: `deity:Baal`); Tribe of Judah (ID: `group:Judah`); Jerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Men (ID: `group:GenericMales`); LORD (ID: `deity:Lord`); Jerusalem (ID: `place:Jerusalem`); Appoint (ID: `keyterm:Appoint`); Wine (ID: `realia:Wine`); Lamp (ID: `realia:Lamp`)
...
* **Associated ACAI Concepts:** Canaan (ID: `place:Canaan`); Cherethites (ID: `group:Cherethite`); Philistines (ID: `group:Philistine`); Woe (ID: `keyterm:Woe.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Philistia (ID: `place:Philistine`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Ashkelon (ID: `place:Ashkelon`); LORD (ID: `deity:Lord`); Appoint (ID: `keyterm:Appoint`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ammon (ID: `place:Ammon`); Israel (ID: `person:Israel`); Ammonites (ID: `group:Ammon`); Moab (ID: `place:Moab`); Gomorrah (ID: `place:Gomorrah`); Sodom (ID: `place:Sodom`); LORD (ID: `deity:Lord`); Nettle (ID: `flora:Nettle`)
...
* **Associated ACAI Concepts:** Owl (ID: `fauna:Owl.3`); Crow (ID: `fauna:Crow`); Doorstep (ID: `realia:Doorstep`); Window (ID: `realia:Window`); Jackdaw (ID: `fauna:Jackdaw`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Capital (ID: `realia:Capital`)
