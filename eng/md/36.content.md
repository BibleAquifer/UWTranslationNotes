...
* **Associated ACAI Concepts:** Zephaniah (ID: `person:Zephaniah.3`); Hezekiah (ID: `person:Hezekiah.4`); Cushi (ID: `person:Cushi`); Gedaliah (ID: `person:Gedaliah.3`); Amariah (ID: `person:Amariah.9`); Amon (ID: `person:Amon.3`); Josiah (ID: `person:Josiah`); Judah (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Tribe of Judah (ID: `group:Judah`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Appoint (ID: `keyterm:Appoint`); LORD (ID: `deity:Lord`); Men (ID: `group:GenericMales`); Wine (ID: `realia:Wine`); Lamp (ID: `realia:Lamp`)
...
* **Associated ACAI Concepts:** Philistia (ID: `place:Philistine`); Philistines (ID: `group:Philistine`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Cherethites (ID: `group:Cherethite`); Woe (ID: `keyterm:Woe.2`); Canaan (ID: `place:Canaan`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Appoint (ID: `keyterm:Appoint`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Ashkelon (ID: `place:Ashkelon`); LORD (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Gomorrah (ID: `place:Gomorrah`); Ammonites (ID: `group:Ammon`); Ammon (ID: `place:Ammon`); Israel (ID: `person:Israel`); Moab (ID: `place:Moab`); LORD (ID: `deity:Lord`); Sodom (ID: `place:Sodom`); Nettle (ID: `flora:Nettle`)
...
* **Associated ACAI Concepts:** Owl (ID: `fauna:Owl.3`); Window (ID: `realia:Window`); Capital (ID: `realia:Capital`); Flock (ID: `fauna:Flock`); Doorstep (ID: `realia:Doorstep`); Crow (ID: `fauna:Crow`); Jackdaw (ID: `fauna:Jackdaw`); Goat (ID: `fauna:Goat`)
