...
* **Associated ACAI Concepts:** Zephaniah (ID: `person:Zephaniah.3`); Gedaliah (ID: `person:Gedaliah.3`); Cushi (ID: `person:Cushi`); Amariah (ID: `person:Amariah.9`); Hezekiah (ID: `person:Hezekiah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); LORD (ID: `deity:Lord`); Amon (ID: `person:Amon.3`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Josiah (ID: `person:Josiah`)
...
* **Associated ACAI Concepts:** Men (ID: `group:GenericMales`); Appoint (ID: `keyterm:Appoint`); Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Lamp (ID: `realia:Lamp`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Word of the Lord (ID: `keyterm:WordOfTheLord`); Philistia (ID: `place:Philistine`); LORD (ID: `deity:Lord`); Philistines (ID: `group:Philistine`); Canaan (ID: `place:Canaan`); Cherethites (ID: `group:Cherethite`); Woe (ID: `keyterm:Woe.2`)
...
* **Associated ACAI Concepts:** Sodom (ID: `place:Sodom`); Ammonites (ID: `group:Ammon`); Moab (ID: `place:Moab`); Israel (ID: `person:Israel`); Gomorrah (ID: `place:Gomorrah`); LORD (ID: `deity:Lord`); Ammon (ID: `place:Ammon`); Nettle (ID: `flora:Nettle`)
