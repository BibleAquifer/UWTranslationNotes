...
* **Associated ACAI Concepts:** Cushi (ID: `person:Cushi`); Hezekiah (ID: `person:Hezekiah.4`); Zephaniah (ID: `person:Zephaniah.3`); Amariah (ID: `person:Amariah.9`); Gedaliah (ID: `person:Gedaliah.3`); LORD (ID: `deity:Lord`); Josiah (ID: `person:Josiah`); Judah (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Tribe of Judah (ID: `group:Judah`); Amon (ID: `person:Amon.3`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jerusalem (ID: `place:Jerusalem`); Appoint (ID: `keyterm:Appoint`); Men (ID: `group:GenericMales`); Wine (ID: `realia:Wine`); Lamp (ID: `realia:Lamp`)
...
* **Associated ACAI Concepts:** Ashdod (ID: `place:Ashdod`); Ekron (ID: `place:Ekron`); Ashkelon (ID: `place:Ashkelon`); Gaza (ID: `place:Gaza`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Cherethites (ID: `group:Cherethite`); Woe (ID: `keyterm:Woe.2`); Canaan (ID: `place:Canaan`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Philistines (ID: `group:Philistine`); Philistia (ID: `place:Philistine`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Appoint (ID: `keyterm:Appoint`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Ashkelon (ID: `place:Ashkelon`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Sodom (ID: `place:Sodom`); Gomorrah (ID: `place:Gomorrah`); LORD (ID: `deity:Lord`); Moab (ID: `place:Moab`); Israel (ID: `person:Israel`); Ammon (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Nettle (ID: `flora:Nettle`)
...
* **Associated ACAI Concepts:** Owl (ID: `fauna:Owl.3`); Crow (ID: `fauna:Crow`); Doorstep (ID: `realia:Doorstep`); Window (ID: `realia:Window`); Jackdaw (ID: `fauna:Jackdaw`); Capital (ID: `realia:Capital`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
