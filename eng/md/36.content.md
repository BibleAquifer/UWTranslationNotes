...
* **Associated ACAI Concepts:** Cushi (ID: `person:Cushi`); Zephaniah (ID: `person:Zephaniah.3`); Gedaliah (ID: `person:Gedaliah.3`); Hezekiah (ID: `person:Hezekiah.4`); Amariah (ID: `person:Amariah.9`); Josiah (ID: `person:Josiah`); LORD (ID: `deity:Lord`); Tribe of Judah (ID: `group:Judah`); Amon (ID: `person:Amon.3`); Judah (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Appoint (ID: `keyterm:Appoint`); Jerusalem (ID: `place:Jerusalem`); Men (ID: `group:GenericMales`); Wine (ID: `realia:Wine`); Lamp (ID: `realia:Lamp`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Canaan (ID: `place:Canaan`); Philistia (ID: `place:Philistine`); Woe (ID: `keyterm:Woe.2`); Cherethites (ID: `group:Cherethite`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Philistines (ID: `group:Philistine`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Appoint (ID: `keyterm:Appoint`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Ashkelon (ID: `place:Ashkelon`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ammon (ID: `place:Ammon`); LORD (ID: `deity:Lord`); Gomorrah (ID: `place:Gomorrah`); Sodom (ID: `place:Sodom`); Moab (ID: `place:Moab`); Ammonites (ID: `group:Ammon`); Israel (ID: `person:Israel`); Nettle (ID: `flora:Nettle`)
...
* **Associated ACAI Concepts:** Owl (ID: `fauna:Owl.3`); Window (ID: `realia:Window`); Doorstep (ID: `realia:Doorstep`); Crow (ID: `fauna:Crow`); Goat (ID: `fauna:Goat`); Capital (ID: `realia:Capital`); Flock (ID: `fauna:Flock`); Jackdaw (ID: `fauna:Jackdaw`)
