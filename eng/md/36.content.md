...
* **Associated ACAI Concepts:** Zephaniah (ID: `person:Zephaniah.3`); Cushi (ID: `person:Cushi`); Amariah (ID: `person:Amariah.9`); Hezekiah (ID: `person:Hezekiah.4`); Gedaliah (ID: `person:Gedaliah.3`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Josiah (ID: `person:Josiah`); LORD (ID: `deity:Lord`); Tribe of Judah (ID: `group:Judah`); Amon (ID: `person:Amon.3`); Judah (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Men (ID: `group:GenericMales`); LORD (ID: `deity:Lord`); Appoint (ID: `keyterm:Appoint`); Jerusalem (ID: `place:Jerusalem`); Wine (ID: `realia:Wine`); Lamp (ID: `realia:Lamp`)
...
* **Associated ACAI Concepts:** Ashdod (ID: `place:Ashdod`); Gaza (ID: `place:Gaza`); Ashkelon (ID: `place:Ashkelon`); Ekron (ID: `place:Ekron`)
...
* **Associated ACAI Concepts:** Canaan (ID: `place:Canaan`); Word of the Lord (ID: `keyterm:WordOfTheLord`); LORD (ID: `deity:Lord`); Cherethites (ID: `group:Cherethite`); Woe (ID: `keyterm:Woe.2`); Philistines (ID: `group:Philistine`); Philistia (ID: `place:Philistine`)
...
* **Associated ACAI Concepts:** Ashkelon (ID: `place:Ashkelon`); LORD (ID: `deity:Lord`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Appoint (ID: `keyterm:Appoint`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`); Moab (ID: `place:Moab`); Gomorrah (ID: `place:Gomorrah`); Ammonites (ID: `group:Ammon`); Sodom (ID: `place:Sodom`); Ammon (ID: `place:Ammon`); Nettle (ID: `flora:Nettle`)
...
* **Associated ACAI Concepts:** Owl (ID: `fauna:Owl.3`); Crow (ID: `fauna:Crow`); Goat (ID: `fauna:Goat`); Doorstep (ID: `realia:Doorstep`); Window (ID: `realia:Window`); Flock (ID: `fauna:Flock`); Capital (ID: `realia:Capital`); Jackdaw (ID: `fauna:Jackdaw`)
