...
* **Associated ACAI Concepts:** Cushi (ID: `person:Cushi`); Gedaliah (ID: `person:Gedaliah.3`); Hezekiah (ID: `person:Hezekiah.4`); Zephaniah (ID: `person:Zephaniah.3`); Amariah (ID: `person:Amariah.9`); Amon (ID: `person:Amon.3`); Word of the Lord (ID: `keyterm:WordOfTheLord`); LORD (ID: `deity:Lord`); Josiah (ID: `person:Josiah`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Men (ID: `group:GenericMales`); Jerusalem (ID: `place:Jerusalem`); Appoint (ID: `keyterm:Appoint`); Lamp (ID: `realia:Lamp`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Ashdod (ID: `place:Ashdod`); Gaza (ID: `place:Gaza`); Ekron (ID: `place:Ekron`); Ashkelon (ID: `place:Ashkelon`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); Philistines (ID: `group:Philistine`); Word of the Lord (ID: `keyterm:WordOfTheLord`); LORD (ID: `deity:Lord`); Cherethites (ID: `group:Cherethite`); Canaan (ID: `place:Canaan`); Philistia (ID: `place:Philistine`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Ashkelon (ID: `place:Ashkelon`); Judah (ID: `person:Judah.4`); Appoint (ID: `keyterm:Appoint`); Tribe of Judah (ID: `group:Judah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ammonites (ID: `group:Ammon`); Sodom (ID: `place:Sodom`); LORD (ID: `deity:Lord`); Ammon (ID: `place:Ammon`); Gomorrah (ID: `place:Gomorrah`); Moab (ID: `place:Moab`); Israel (ID: `person:Israel`); Nettle (ID: `flora:Nettle`)
...
* **Associated ACAI Concepts:** Owl (ID: `fauna:Owl.3`); Flock (ID: `fauna:Flock`); Crow (ID: `fauna:Crow`); Doorstep (ID: `realia:Doorstep`); Jackdaw (ID: `fauna:Jackdaw`); Window (ID: `realia:Window`); Capital (ID: `realia:Capital`); Goat (ID: `fauna:Goat`)
