...
* **Associated ACAI Concepts:** Zephaniah (ID: `person:Zephaniah.3`); Hezekiah (ID: `person:Hezekiah.4`); Gedaliah (ID: `person:Gedaliah.3`); Cushi (ID: `person:Cushi`); Amariah (ID: `person:Amariah.9`); LORD (ID: `deity:Lord`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Josiah (ID: `person:Josiah`); Amon (ID: `person:Amon.3`)
...
* **Associated ACAI Concepts:** Appoint (ID: `keyterm:Appoint`); Men (ID: `group:GenericMales`); LORD (ID: `deity:Lord`); Jerusalem (ID: `place:Jerusalem`); Lamp (ID: `realia:Lamp`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); LORD (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Cherethites (ID: `group:Cherethite`); Philistines (ID: `group:Philistine`); Canaan (ID: `place:Canaan`); Philistia (ID: `place:Philistine`)
...
* **Associated ACAI Concepts:** Gomorrah (ID: `place:Gomorrah`); Sodom (ID: `place:Sodom`); Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`); Ammon (ID: `place:Ammon`); Moab (ID: `place:Moab`); Ammonites (ID: `group:Ammon`); Nettle (ID: `flora:Nettle`)
