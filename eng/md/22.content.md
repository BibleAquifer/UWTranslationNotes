...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Solomon (ID: `person:Solomon`); Kedar (ID: `person:Kedar`); Linen Strips (ID: `realia:LinenStrips`); Tent (ID: `realia:Tent`); Goat Hair Strips (ID: `realia:GoatHairStrips`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Love (ID: `keyterm:Love`); Money (ID: `realia:Money`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Passion (ID: `keyterm:Ardour`); Hell (ID: `place:Hell`); House (ID: `realia:House`); Apple (ID: `flora:AppleTree`)
