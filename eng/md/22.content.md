...
* **Associated ACAI Concepts:** Solomon (ID: `person:Solomon`); Jerusalem (ID: `place:Jerusalem`); Kedar (ID: `person:Kedar`); Goat Hair Strips (ID: `realia:GoatHairStrips`); Linen Strips (ID: `realia:LinenStrips`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Lebanon (ID: `place:Lebanon`); Solomon (ID: `person:Solomon`); Jerusalem (ID: `place:Jerusalem`); Purple Cloth (ID: `realia:PurpleCloth`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Hell (ID: `place:Hell`); Passion (ID: `keyterm:Ardour`); House (ID: `realia:House`); Apple (ID: `flora:AppleTree`)
