...
* **Associated ACAI Concepts:** Solomon (ID: `person:Solomon`); Kedar (ID: `person:Kedar`); Jerusalem (ID: `place:Jerusalem`); Tent (ID: `realia:Tent`); Goat Hair Strips (ID: `realia:GoatHairStrips`); Linen Strips (ID: `realia:LinenStrips`)
...
* **Associated ACAI Concepts:** Solomon (ID: `person:Solomon`); Love (ID: `keyterm:Love`); Jerusalem (ID: `place:Jerusalem`); Lebanon (ID: `place:Lebanon`); Purple Cloth (ID: `realia:PurpleCloth`); Money (ID: `realia:Money`)
