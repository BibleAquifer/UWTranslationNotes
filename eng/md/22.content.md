...
* **Associated ACAI Concepts:** Solomon (ID: `person:Solomon`); Love (ID: `keyterm:Love`); Jerusalem (ID: `place:Jerusalem`); Lebanon (ID: `place:Lebanon`); Money (ID: `realia:Money`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** Gilead (ID: `place:Gilead`); Dove (ID: `fauna:Dove`); Goat (ID: `fauna:Goat`); Veil (ID: `realia:Veil`); Flock (ID: `fauna:Flock`)
