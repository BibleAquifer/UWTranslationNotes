...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Solomon (ID: `person:Solomon`); Kedar (ID: `person:Kedar`); Goat Hair Strips (ID: `realia:GoatHairStrips`); Linen Strips (ID: `realia:LinenStrips`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** Lebanon (ID: `place:Lebanon`); Jerusalem (ID: `place:Jerusalem`); Solomon (ID: `person:Solomon`); Love (ID: `keyterm:Love`); Money (ID: `realia:Money`); Purple Cloth (ID: `realia:PurpleCloth`)
