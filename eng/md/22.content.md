...
* **Associated ACAI Concepts:** Solomon (ID: `person:Solomon`); Kedar (ID: `person:Kedar`); Jerusalem (ID: `place:Jerusalem`); Goat Hair Strips (ID: `realia:GoatHairStrips`); Tent (ID: `realia:Tent`); Linen Strips (ID: `realia:LinenStrips`)
