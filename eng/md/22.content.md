...
* **Associated ACAI Concepts:** Lebanon (ID: `place:Lebanon`); Solomon (ID: `person:Solomon`); Love (ID: `keyterm:Love`); Jerusalem (ID: `place:Jerusalem`); Purple Cloth (ID: `realia:PurpleCloth`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Gilead (ID: `place:Gilead`); Veil (ID: `realia:Veil`); Dove (ID: `fauna:Dove`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
