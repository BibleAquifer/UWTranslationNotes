...
* **Associated Passages:** Song of Songs 0:1
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Kedar (ID: `person:Kedar`); Solomon (ID: `person:Solomon`); Tent (ID: `realia:Tent`); Linen Strips (ID: `realia:LinenStrips`); Goat Hair Strips (ID: `realia:GoatHairStrips`)
...
* **Associated ACAI Concepts:** Lebanon (ID: `place:Lebanon`); Jerusalem (ID: `place:Jerusalem`); Love (ID: `keyterm:Love`); Solomon (ID: `person:Solomon`); Purple Cloth (ID: `realia:PurpleCloth`); Money (ID: `realia:Money`)
