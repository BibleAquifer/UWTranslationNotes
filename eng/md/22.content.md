...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Solomon (ID: `person:Solomon`); Lebanon (ID: `place:Lebanon`); Jerusalem (ID: `place:Jerusalem`); Purple Cloth (ID: `realia:PurpleCloth`); Money (ID: `realia:Money`)
