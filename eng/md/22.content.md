...
* **Associated ACAI Concepts:** Solomon (ID: `person:Solomon`); Lebanon (ID: `place:Lebanon`); Jerusalem (ID: `place:Jerusalem`); Love (ID: `keyterm:Love`); Purple Cloth (ID: `realia:PurpleCloth`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Gilead (ID: `place:Gilead`); Dove (ID: `fauna:Dove`); Flock (ID: `fauna:Flock`); Veil (ID: `realia:Veil`); Goat (ID: `fauna:Goat`)
