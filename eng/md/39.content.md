...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Edom (ID: `place:Edom`); LORD (ID: `deity:Lord`); Love (ID: `keyterm:Love`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** Defile (ID: `keyterm:Stain`); LORD (ID: `deity:Lord`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); LORD (ID: `deity:Lord`); Gentiles (ID: `group:Gentile`); Pure (ID: `keyterm:Pure`)
...
* **Associated ACAI Concepts:** To Curse (ID: `keyterm:Curse`); Vow (ID: `keyterm:Vow`); LORD (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Covenant (ID: `keyterm:Covenant`); Fear (ID: `keyterm:Fear`); Peace (ID: `keyterm:IntactState`)
...
* **Associated ACAI Concepts:** Fairness (ID: `keyterm:Fairness`); Passion (ID: `keyterm:Ardour`); Peace (ID: `keyterm:IntactState`); Instruction (ID: `keyterm:Instruction`); Truth (ID: `keyterm:Truth`)
...
* **Associated ACAI Concepts:** Judah (ID: `person:Judah.4`); Israel (ID: `person:Israel`); Tribe of Judah (ID: `group:Judah`); To Dishonor (ID: `keyterm:Dishonor`); LORD (ID: `deity:Lord`); Jerusalem (ID: `place:Jerusalem`); Love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); LORD (ID: `deity:Lord`); Delight (ID: `keyterm:Delight`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); Levi (ID: `person:Levi.3`); Tribe of Levi (ID: `group:Levi`); LORD (ID: `deity:Lord`); Pure (ID: `keyterm:Pure`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); LORD (ID: `deity:Lord`); Jerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Moses (ID: `person:Moses`); Decree (ID: `keyterm:Decree`); Israel (ID: `person:Israel`); Mount Sinai (ID: `place:SinaiMount`); Instruction (ID: `keyterm:Instruction`)
