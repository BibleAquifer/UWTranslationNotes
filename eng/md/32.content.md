...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Nineveh (ID: `place:Nineveh`); Believe In (ID: `keyterm:BelieveIn`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** Kindness (ID: `keyterm:Kindness`); Tarshish (ID: `place:Tarshish`); LORD (ID: `deity:Lord`); Generous (ID: `keyterm:Generous`); Compassionate (ID: `keyterm:Compassionate`)
