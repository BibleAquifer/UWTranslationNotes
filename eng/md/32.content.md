...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Jonah (ID: `person:Jonah.2`)
...
* **Associated ACAI Concepts:** Tarshish (ID: `place:Tarshish`); LORD (ID: `deity:Lord`); Compassionate (ID: `keyterm:Compassionate`); Generous (ID: `keyterm:Generous`); Kindness (ID: `keyterm:Kindness`)
