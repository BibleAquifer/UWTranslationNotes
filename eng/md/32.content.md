...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Praise (ID: `keyterm:Praise`); Salvation (ID: `keyterm:Salvation`); Vow (ID: `keyterm:Vow`)
...
* **Associated ACAI Concepts:** Tarshish (ID: `place:Tarshish`); Generous (ID: `keyterm:Generous`); Compassionate (ID: `keyterm:Compassionate`); Kindness (ID: `keyterm:Kindness`); LORD (ID: `deity:Lord`)
