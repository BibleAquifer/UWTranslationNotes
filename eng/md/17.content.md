...
* **Associated ACAI Concepts:** Carkas (ID: `person:Carkas`); Zethar (ID: `person:Zethar`); Harbona (ID: `person:Harbona`); Abagtha (ID: `person:Abagtha`); Mehuman (ID: `person:Mehuman`); Bigtha (ID: `person:Bigtha`); Biztha (ID: `person:Biztha`); Ahasuerus (ID: `person:Ahasuerus`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Admatha (ID: `person:Admatha`); Memucan (ID: `person:Memucan`); Carshena (ID: `person:Carshena`); Meres (ID: `person:Meres`); Marsena (ID: `person:Marsena`); Shethar (ID: `person:Shethar`); Media (ID: `place:Media`); Tarshish (ID: `place:Tarshish`); Persia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Vashti (ID: `person:Vashti`); Medes (ID: `group:Mede`); Persians (ID: `group:Persia`); Medan (ID: `person:Medan`); Ahasuerus (ID: `person:Ahasuerus`); Persia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Kish (ID: `person:Kish.4`); Shimei (ID: `person:Shimei.18`); Jair (ID: `person:Jair.4`); Benjamin (ID: `person:Benjamin`); Jews (ID: `group:Jews`); Tribe of Benjamin (ID: `group:Benjamin`); Susa (ID: `place:Susa`)
...
* **Associated ACAI Concepts:** Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Babylon (ID: `place:Babylon`); Jehoiachin (ID: `person:Jehoiachin`); Jerusalem (ID: `place:Jerusalem`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Esther (ID: `person:Esther`); Peace (ID: `keyterm:IntactState`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); Esther (ID: `person:Esther`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Zeresh (ID: `person:Zeresh`); Mordecai (ID: `person:Mordecai.2`); A Group of People (ID: `group:GenericGroup`); Love (ID: `keyterm:Love`); Jews (ID: `group:Jews`); Haman (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Favor (ID: `keyterm:Favor`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Jews (ID: `group:Jews`); Haman (ID: `person:Haman`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); Esther (ID: `person:Esther`); Haman (ID: `person:Haman`); Ahasuerus (ID: `person:Ahasuerus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Parmashta (ID: `person:Parmashta`); Aridai (ID: `person:Aridai`); Arisai (ID: `person:Arisai`); Vaizatha (ID: `person:Vaizatha`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Jews (ID: `group:Jews`); Haman (ID: `person:Haman`); Lot (ID: `keyterm:Lot`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); Jews (ID: `group:Jews`); Peace (ID: `keyterm:IntactState`); Ahasuerus (ID: `person:Ahasuerus`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); Esther (ID: `person:Esther`)
