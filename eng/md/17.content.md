...
* **Associated ACAI Concepts:** Abagtha (ID: `person:Abagtha`); Mehuman (ID: `person:Mehuman`); Bigtha (ID: `person:Bigtha`); Harbona (ID: `person:Harbona`); Zethar (ID: `person:Zethar`); Carkas (ID: `person:Carkas`); Biztha (ID: `person:Biztha`); Ahasuerus (ID: `person:Ahasuerus`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Carshena (ID: `person:Carshena`); Admatha (ID: `person:Admatha`); Marsena (ID: `person:Marsena`); Meres (ID: `person:Meres`); Shethar (ID: `person:Shethar`); Memucan (ID: `person:Memucan`); Persia (ID: `place:Persia`); Tarshish (ID: `place:Tarshish`); Media (ID: `place:Media`)
...
* **Associated ACAI Concepts:** Vashti (ID: `person:Vashti`); Medes (ID: `group:Mede`); Ahasuerus (ID: `person:Ahasuerus`); Medan (ID: `person:Medan`); Persians (ID: `group:Persia`); Persia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Shimei (ID: `person:Shimei.18`); Mordecai (ID: `person:Mordecai.2`); Jair (ID: `person:Jair.4`); Kish (ID: `person:Kish.4`); Jews (ID: `group:Jews`); Benjamin (ID: `person:Benjamin`); Tribe of Benjamin (ID: `group:Benjamin`); Susa (ID: `place:Susa`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Babylon (ID: `place:Babylon`); Jehoiachin (ID: `person:Jehoiachin`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Agagites (ID: `group:Agag`); Jews (ID: `group:Jews`); Hammedatha (ID: `person:Hammedatha`); Agag (ID: `person:Agag.2`)
...
* **Associated ACAI Concepts:** Zeresh (ID: `person:Zeresh`); Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); Love (ID: `keyterm:Love`); A Group of People (ID: `group:GenericGroup`); Haman (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Esther (ID: `person:Esther`); Mordecai (ID: `person:Mordecai.2`); Ahasuerus (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`); Haman (ID: `person:Haman`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Agagites (ID: `group:Agag`); Esther (ID: `person:Esther`); Jews (ID: `group:Jews`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Haman (ID: `person:Haman`); Agag (ID: `person:Agag.2`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); Jews (ID: `group:Jews`); Haman (ID: `person:Haman`); Agag (ID: `person:Agag.2`); Favor (ID: `keyterm:Favor`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); Jews (ID: `group:Jews`); Lot (ID: `keyterm:Lot`); Haman (ID: `person:Haman`); Agag (ID: `person:Agag.2`); Lot (ID: `realia:Lot`)
