...
* **Associated ACAI Concepts:** Bigtha (ID: `person:Bigtha`); Abagtha (ID: `person:Abagtha`); Carkas (ID: `person:Carkas`); Zethar (ID: `person:Zethar`); Mehuman (ID: `person:Mehuman`); Biztha (ID: `person:Biztha`); Harbona (ID: `person:Harbona`); Ahasuerus (ID: `person:Ahasuerus`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Carshena (ID: `person:Carshena`); Admatha (ID: `person:Admatha`); Meres (ID: `person:Meres`); Memucan (ID: `person:Memucan`); Shethar (ID: `person:Shethar`); Marsena (ID: `person:Marsena`); Tarshish (ID: `place:Tarshish`); Media (ID: `place:Media`); Persia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Jair (ID: `person:Jair.4`); Kish (ID: `person:Kish.4`); Mordecai (ID: `person:Mordecai.2`); Shimei (ID: `person:Shimei.18`); Tribe of Benjamin (ID: `group:Benjamin`); Benjamin (ID: `person:Benjamin`); Susa (ID: `place:Susa`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Jerusalem (ID: `place:Jerusalem`); Babylon (ID: `place:Babylon`); Jehoiachin (ID: `person:Jehoiachin`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Jews (ID: `group:Jews`); Hammedatha (ID: `person:Hammedatha`)
...
* **Associated ACAI Concepts:** Zeresh (ID: `person:Zeresh`); Love (ID: `keyterm:Love`); Jews (ID: `group:Jews`); Mordecai (ID: `person:Mordecai.2`); A Group of People (ID: `group:GenericGroup`); Haman (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Agagites (ID: `group:Agag`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Agag (ID: `person:Agag.2`); Jews (ID: `group:Jews`); Haman (ID: `person:Haman`); Esther (ID: `person:Esther`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Favor (ID: `keyterm:Favor`); Jews (ID: `group:Jews`); Haman (ID: `person:Haman`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Mordecai (ID: `person:Mordecai.2`); Ahasuerus (ID: `person:Ahasuerus`); Haman (ID: `person:Haman`); Esther (ID: `person:Esther`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Vaizatha (ID: `person:Vaizatha`); Parmashta (ID: `person:Parmashta`); Arisai (ID: `person:Arisai`); Aridai (ID: `person:Aridai`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Jews (ID: `group:Jews`); Lot (ID: `keyterm:Lot`); Haman (ID: `person:Haman`); Lot (ID: `realia:Lot`)
