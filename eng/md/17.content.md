...
* **Associated ACAI Concepts:** Carkas (ID: `person:Carkas`); Zethar (ID: `person:Zethar`); Abagtha (ID: `person:Abagtha`); Bigtha (ID: `person:Bigtha`); Mehuman (ID: `person:Mehuman`); Harbona (ID: `person:Harbona`); Biztha (ID: `person:Biztha`); Ahasuerus (ID: `person:Ahasuerus`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Marsena (ID: `person:Marsena`); Shethar (ID: `person:Shethar`); Carshena (ID: `person:Carshena`); Meres (ID: `person:Meres`); Memucan (ID: `person:Memucan`); Admatha (ID: `person:Admatha`); Media (ID: `place:Media`); Tarshish (ID: `place:Tarshish`); Persia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Vashti (ID: `person:Vashti`); Ahasuerus (ID: `person:Ahasuerus`); Medan (ID: `person:Medan`); Persians (ID: `group:Persia`); Persia (ID: `place:Persia`); Medes (ID: `group:Mede`)
...
* **Associated ACAI Concepts:** Jair (ID: `person:Jair.4`); Shimei (ID: `person:Shimei.18`); Mordecai (ID: `person:Mordecai.2`); Kish (ID: `person:Kish.4`); Benjamin (ID: `person:Benjamin`); Jews (ID: `group:Jews`); Susa (ID: `place:Susa`); Tribe of Benjamin (ID: `group:Benjamin`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Hammedatha (ID: `person:Hammedatha`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Agag (ID: `person:Agag.2`); Agagites (ID: `group:Agag`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Esther (ID: `person:Esther`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Haman (ID: `person:Haman`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Favor (ID: `keyterm:Favor`); Jews (ID: `group:Jews`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Haman (ID: `person:Haman`); Lot (ID: `keyterm:Lot`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Jews (ID: `group:Jews`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** Ahasuerus (ID: `person:Ahasuerus`); Peace (ID: `keyterm:IntactState`); Jews (ID: `group:Jews`); Truth (ID: `keyterm:Truth`); Scroll (ID: `realia:Scroll`)
