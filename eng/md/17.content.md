...
* **Associated ACAI Concepts:** Abagtha (ID: `person:Abagtha`); Zethar (ID: `person:Zethar`); Carkas (ID: `person:Carkas`); Bigtha (ID: `person:Bigtha`); Biztha (ID: `person:Biztha`); Mehuman (ID: `person:Mehuman`); Harbona (ID: `person:Harbona`); Ahasuerus (ID: `person:Ahasuerus`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Meres (ID: `person:Meres`); Carshena (ID: `person:Carshena`); Memucan (ID: `person:Memucan`); Marsena (ID: `person:Marsena`); Admatha (ID: `person:Admatha`); Shethar (ID: `person:Shethar`); Tarshish (ID: `place:Tarshish`); Media (ID: `place:Media`); Persia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Vashti (ID: `person:Vashti`); Medes (ID: `group:Mede`); Medan (ID: `person:Medan`); Persians (ID: `group:Persia`); Ahasuerus (ID: `person:Ahasuerus`); Persia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Kish (ID: `person:Kish.4`); Mordecai (ID: `person:Mordecai.2`); Jair (ID: `person:Jair.4`); Shimei (ID: `person:Shimei.18`); Benjamin (ID: `person:Benjamin`); Susa (ID: `place:Susa`); Tribe of Benjamin (ID: `group:Benjamin`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Judah (ID: `person:Judah.4`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Tribe of Judah (ID: `group:Judah`); Babylon (ID: `place:Babylon`); Jehoiachin (ID: `person:Jehoiachin`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); Haman (ID: `person:Haman`); Agag (ID: `person:Agag.2`); Ahasuerus (ID: `person:Ahasuerus`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); Haman (ID: `person:Haman`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Hammedatha (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); Haman (ID: `person:Haman`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); Haman (ID: `person:Haman`); Horse (ID: `fauna:Horse`)
...
* **Associated ACAI Concepts:** Zeresh (ID: `person:Zeresh`); Love (ID: `keyterm:Love`); Haman (ID: `person:Haman`); A Group of People (ID: `group:GenericGroup`); Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Esther (ID: `person:Esther`); Agagites (ID: `group:Agag`); Haman (ID: `person:Haman`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Agag (ID: `person:Agag.2`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Arisai (ID: `person:Arisai`); Aridai (ID: `person:Aridai`); Vaizatha (ID: `person:Vaizatha`); Parmashta (ID: `person:Parmashta`)
