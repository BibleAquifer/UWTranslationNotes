...
If your language does not use abstract nouns for the ideas of **wealth** and **glory**, you could express the same ideas in other ways. Alternate translation: \[when he displayed how glorious and wealthy his kingdom was]
...
וְ⁠אֶ֨ת־יְקָ֔ר תִּפְאֶ֖רֶת גְּדוּלָּת֑⁠וֹ

**"and the splendor of the beauty of his greatness"**

If your language does not use abstract nouns for the ideas of **splendor**, **beauty**, and **greatness** in another way. Alternate translation: \[and that he was a very powerful king]
...
* **Associated ACAI Concepts:** Carkas (ID: `person:Carkas`); Harbona (ID: `person:Harbona`); Bigtha (ID: `person:Bigtha`); Zethar (ID: `person:Zethar`); Biztha (ID: `person:Biztha`); Abagtha (ID: `person:Abagtha`); Mehuman (ID: `person:Mehuman`); Ahasuerus (ID: `person:Ahasuerus`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Admatha (ID: `person:Admatha`); Shethar (ID: `person:Shethar`); Meres (ID: `person:Meres`); Marsena (ID: `person:Marsena`); Carshena (ID: `person:Carshena`); Memucan (ID: `person:Memucan`); Persia (ID: `place:Persia`); Tarshish (ID: `place:Tarshish`); Media (ID: `place:Media`)
...
* **Associated ACAI Concepts:** Jair (ID: `person:Jair.4`); Mordecai (ID: `person:Mordecai.2`); Shimei (ID: `person:Shimei.18`); Kish (ID: `person:Kish.4`); Tribe of Benjamin (ID: `group:Benjamin`); Jews (ID: `group:Jews`); Susa (ID: `place:Susa`); Benjamin (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Tribe of Judah (ID: `group:Judah`); Babylon (ID: `place:Babylon`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Jehoiachin (ID: `person:Jehoiachin`); Judah (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Haman (ID: `person:Haman`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Ahasuerus (ID: `person:Ahasuerus`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Jews (ID: `group:Jews`); Hammedatha (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`)
...
**Glory** and **wealth** are both abstract nouns. Alternate translation: \[Haman told them about how gloriously wealthy he was] or \[Haman told them about the many great things he owned]
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Haman (ID: `person:Haman`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Esther (ID: `person:Esther`); To Beg for Mercy (ID: `keyterm:BegForMercy`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Mordecai (ID: `person:Mordecai.2`); Haman (ID: `person:Haman`); Esther (ID: `person:Esther`); Ahasuerus (ID: `person:Ahasuerus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Lot (ID: `keyterm:Lot`); Jews (ID: `group:Jews`); Haman (ID: `person:Haman`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Truth (ID: `keyterm:Truth`); Peace (ID: `keyterm:IntactState`); Ahasuerus (ID: `person:Ahasuerus`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Ahasuerus (ID: `person:Ahasuerus`); Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); Peace (ID: `keyterm:IntactState`)
