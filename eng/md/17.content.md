...
* **Associated ACAI Concepts:** Zethar (ID: `person:Zethar`); Biztha (ID: `person:Biztha`); Carkas (ID: `person:Carkas`); Mehuman (ID: `person:Mehuman`); Bigtha (ID: `person:Bigtha`); Abagtha (ID: `person:Abagtha`); Harbona (ID: `person:Harbona`); Ahasuerus (ID: `person:Ahasuerus`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Shethar (ID: `person:Shethar`); Marsena (ID: `person:Marsena`); Memucan (ID: `person:Memucan`); Meres (ID: `person:Meres`); Admatha (ID: `person:Admatha`); Carshena (ID: `person:Carshena`); Persia (ID: `place:Persia`); Tarshish (ID: `place:Tarshish`); Media (ID: `place:Media`)
...
* **Associated ACAI Concepts:** Vashti (ID: `person:Vashti`); Persia (ID: `place:Persia`); Ahasuerus (ID: `person:Ahasuerus`); Medan (ID: `person:Medan`); Medes (ID: `group:Mede`); Persians (ID: `group:Persia`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Kish (ID: `person:Kish.4`); Jair (ID: `person:Jair.4`); Shimei (ID: `person:Shimei.18`); Susa (ID: `place:Susa`); Jews (ID: `group:Jews`); Tribe of Benjamin (ID: `group:Benjamin`); Benjamin (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Babylon (ID: `place:Babylon`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Jehoiachin (ID: `person:Jehoiachin`); Jerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Hammedatha (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Ahasuerus (ID: `person:Ahasuerus`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Agag (ID: `person:Agag.2`); Hammedatha (ID: `person:Hammedatha`); Jews (ID: `group:Jews`); Agagites (ID: `group:Agag`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Haman (ID: `person:Haman`); Jews (ID: `group:Jews`); Horse (ID: `fauna:Horse`)
...
* **Associated ACAI Concepts:** Agag (ID: `person:Agag.2`); Esther (ID: `person:Esther`); Haman (ID: `person:Haman`); Jews (ID: `group:Jews`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Agagites (ID: `group:Agag`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Favor (ID: `keyterm:Favor`); Agag (ID: `person:Agag.2`); Haman (ID: `person:Haman`); Jews (ID: `group:Jews`); Agagites (ID: `group:Agag`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Arisai (ID: `person:Arisai`); Parmashta (ID: `person:Parmashta`); Aridai (ID: `person:Aridai`); Vaizatha (ID: `person:Vaizatha`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Ahasuerus (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Agag (ID: `person:Agag.2`); Haman (ID: `person:Haman`); Lot (ID: `keyterm:Lot`); Jews (ID: `group:Jews`); Agagites (ID: `group:Agag`); Lot (ID: `realia:Lot`)
