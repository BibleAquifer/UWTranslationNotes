...
* **Associated ACAI Concepts:** Bigtha (ID: `person:Bigtha`); Abagtha (ID: `person:Abagtha`); Biztha (ID: `person:Biztha`); Harbona (ID: `person:Harbona`); Zethar (ID: `person:Zethar`); Carkas (ID: `person:Carkas`); Mehuman (ID: `person:Mehuman`); Ahasuerus (ID: `person:Ahasuerus`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Memucan (ID: `person:Memucan`); Marsena (ID: `person:Marsena`); Shethar (ID: `person:Shethar`); Carshena (ID: `person:Carshena`); Admatha (ID: `person:Admatha`); Meres (ID: `person:Meres`); Tarshish (ID: `place:Tarshish`); Media (ID: `place:Media`); Persia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Jair (ID: `person:Jair.4`); Mordecai (ID: `person:Mordecai.2`); Shimei (ID: `person:Shimei.18`); Kish (ID: `person:Kish.4`); Benjamin (ID: `person:Benjamin`); Susa (ID: `place:Susa`); Jews (ID: `group:Jews`); Tribe of Benjamin (ID: `group:Benjamin`)
...
* **Associated ACAI Concepts:** Judah (ID: `person:Judah.4`); Jehoiachin (ID: `person:Jehoiachin`); Jerusalem (ID: `place:Jerusalem`); Babylon (ID: `place:Babylon`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Tribe of Judah (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Esther (ID: `person:Esther`); Love (ID: `keyterm:Love`); Favor (ID: `keyterm:Favor`); Kindness (ID: `keyterm:Kindness`); Vashti (ID: `person:Vashti`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** Ahasuerus (ID: `person:Ahasuerus`); Haman (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Zeresh (ID: `person:Zeresh`); A Group of People (ID: `group:GenericGroup`); Mordecai (ID: `person:Mordecai.2`); Love (ID: `keyterm:Love`); Haman (ID: `person:Haman`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Agagites (ID: `group:Agag`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Esther (ID: `person:Esther`); Agag (ID: `person:Agag.2`); Haman (ID: `person:Haman`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Esther (ID: `person:Esther`); Ahasuerus (ID: `person:Ahasuerus`); Haman (ID: `person:Haman`); Jews (ID: `group:Jews`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); Lot (ID: `keyterm:Lot`); Agag (ID: `person:Agag.2`); Haman (ID: `person:Haman`); Jews (ID: `group:Jews`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** Peace (ID: `keyterm:IntactState`); Truth (ID: `keyterm:Truth`); Ahasuerus (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`); Scroll (ID: `realia:Scroll`)
