...
* **Associated ACAI Concepts:** Abagtha (ID: `person:Abagtha`); Biztha (ID: `person:Biztha`); Mehuman (ID: `person:Mehuman`); Zethar (ID: `person:Zethar`); Carkas (ID: `person:Carkas`); Bigtha (ID: `person:Bigtha`); Harbona (ID: `person:Harbona`); Ahasuerus (ID: `person:Ahasuerus`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Marsena (ID: `person:Marsena`); Meres (ID: `person:Meres`); Carshena (ID: `person:Carshena`); Admatha (ID: `person:Admatha`); Shethar (ID: `person:Shethar`); Memucan (ID: `person:Memucan`); Media (ID: `place:Media`); Tarshish (ID: `place:Tarshish`); Persia (ID: `place:Persia`)
...
* **Associated ACAI Concepts:** Shimei (ID: `person:Shimei.18`); Mordecai (ID: `person:Mordecai.2`); Jair (ID: `person:Jair.4`); Kish (ID: `person:Kish.4`); Jews (ID: `group:Jews`); Susa (ID: `place:Susa`); Tribe of Benjamin (ID: `group:Benjamin`); Benjamin (ID: `person:Benjamin`)
...
* **Associated ACAI Concepts:** Jehoiachin (ID: `person:Jehoiachin`); Judah (ID: `person:Judah.4`); Jerusalem (ID: `place:Jerusalem`); Tribe of Judah (ID: `group:Judah`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Babylon (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** Zeresh (ID: `person:Zeresh`); A Group of People (ID: `group:GenericGroup`); Haman (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Love (ID: `keyterm:Love`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Zeresh (ID: `person:Zeresh`); A Group of People (ID: `group:GenericGroup`); Haman (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); Love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Agagites (ID: `group:Agag`); Jews (ID: `group:Jews`); Agag (ID: `person:Agag.2`); Esther (ID: `person:Esther`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Favor (ID: `keyterm:Favor`); Haman (ID: `person:Haman`); Agagites (ID: `group:Agag`); Jews (ID: `group:Jews`); Agag (ID: `person:Agag.2`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); Esther (ID: `person:Esther`); Ahasuerus (ID: `person:Ahasuerus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Dalphon (ID: `person:Dalphon`); Parshandatha (ID: `person:Parshandatha`); Aspatha (ID: `person:Aspatha`)
...
* **Associated ACAI Concepts:** Parmashta (ID: `person:Parmashta`); Arisai (ID: `person:Arisai`); Vaizatha (ID: `person:Vaizatha`); Aridai (ID: `person:Aridai`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Esther (ID: `person:Esther`); Haman (ID: `person:Haman`); Susa (ID: `place:Susa`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Haman (ID: `person:Haman`); Lot (ID: `keyterm:Lot`); Agagites (ID: `group:Agag`); Jews (ID: `group:Jews`); Agag (ID: `person:Agag.2`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** Ahasuerus (ID: `person:Ahasuerus`); Truth (ID: `keyterm:Truth`); Jews (ID: `group:Jews`); Peace (ID: `keyterm:IntactState`); Scroll (ID: `realia:Scroll`)
