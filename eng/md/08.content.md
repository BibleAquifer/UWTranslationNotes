...
* **Associated ACAI Concepts:** Chilion (ID: `person:Chilion`); Ephrathah (ID: `person:Ephrathah`); Naomi (ID: `person:Naomi`); Ephrathites (ID: `group:Ephrathah`); Elimelech (ID: `person:Elimelech`); Mahlon (ID: `person:Mahlon`); Moab (ID: `place:Moab`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Bethlehem (ID: `place:Bethlehem`)

## Ruth 1:3 (#1) (id: en_tn_RUT_rxb1)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Boaz (ID: `person:Boaz`); Bless (ID: `keyterm:Bless`); Bethlehem (ID: `place:Bethlehem`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Rachel (ID: `person:Rachel`); LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Elders (ID: `group:GenericElders`); Bethlehem (ID: `place:Bethlehem`); Leah (ID: `person:Leah`)
