...
## Colossians - Introduction (id: en_tn_COL_d9hy)
...
* **Associated Passages:** Colossians 0:0
* **Associated Articles:** How to Translate Names (ID: `33391@UWTranslationNotes`); Textual Variants (ID: `33405@UWTranslationNotes`)


## Colossians - Chapter 1 Introduction (id: en_tn_COL_gtm3)

Colossians 1 Chapter Introduction
=================================
...
Throughout this letter the pronouns “we,” “us,” “our,” and “ours” include the Colossian believers unless noted otherwise.

The pronouns “you,” “your,” and “yours” refer to the Colossian believers, so they are plural unless noted otherwise.
...
* **Associated Passages:** Colossians 1:0


## Colossians 1:1 (#2) (id: 244477)
...
* **Associated Passages:** Colossians 1:17
* **Associated Articles:** Metaphor (ID: `33292@UWTranslationNotes`)
...
## Colossians - Chapter 2 Introduction (id: en_tn_COL_p3uc)

Colossians 2 Chapter Introduction
=================================
...
* **Associated Passages:** Colossians 2:0
...
Paul uses the possessive form to explain what the **treasures** are: **wisdom** and **knowledge**. If your language does not use this form to express that idea, you could clarify that **wisdom** and **knowledge** are the **treasures**. Alternate translation: \[are hidden all the treasures, which are wisdom and knowledge,] or \[are all God’s wisdom and knowledge, which are like a treasure that has been hidden]
...
## Colossians 2:7 (#5) (id: en_tn_COL_yh83)
...
This verse gives three commands that are not from Paul, but rather they are examples of the “decrees” from 2:20\. If it would be helpful in your language, you could introduce these commands with a phrase, such as “for example,” to show that they connect to the “decrees” in the previous verse. Alternate translation: \[for example, “You may not handle, nor taste, nor touch]
...
Although the word **men** is masculine, Paul is using the word in a generic sense that includes both men and women. If it would be helpful in your language, you could use a phrase that makes this clear. Alternate translation: \[of men and women] or \[of humans]
...
## Colossians - Chapter 3 Introduction (id: en_tn_COL_qtl2)

Colossians 3 Chapter Introduction
=================================
...
* **Associated Passages:** Colossians 3:0
...
Paul speaks as if he wants the Colossians to look for or try to find **things above**. By using the word **seek**, Paul tells the Colossians to focus on **the things above** as if they were something valuable that the Colossians needed to find. If it would be helpful in your language, you could express the idea with a comparable metaphor, or express it plainly. Alternate translation: \[direct your attention to the things above] or \[focus on the things above]
...
Paul uses the word **raised** to refer to someone who had died and came back to life. If this word does not refer to coming back to life in your language, you could use a comparable idiom or a short phrase. Alternate translation: \[you were restored to life with]
...
## Colossians 3:2 (#1) (id: en_tn_COL_vpat)
...
* **Associated Passages:** Colossians 3:7
* **Associated Articles:** Metaphor (ID: `33292@UWTranslationNotes`)
...
* **Associated Passages:** Colossians 3:9
* **Associated Articles:** Connect — Reason-and-Result Relationship (ID: `33331@UWTranslationNotes`)
...
The word **for** introduces the basis or reason for something; here it is Paul’s command to children. Use a word that indicates the reason for a command in your language. Alternate translation: \[since]
...
## Colossians - Chapter 4 Introduction (id: en_tn_COL_nm3y)

Colossians 4 Chapter Introduction
=================================
...
In 4:1, Paul refers to a “master in heaven.” The word translated as “master” and “masters” in this verse is the same word that is translated as “Lord” throughout Colossians. It is translated as “master” in this verse to illustrate Paul’s point: those who are “masters” on earth also have a “master,” their Lord in heaven. If possible, make this wordplay clear in your translation.

* **Associated Passages:** Colossians 4:0
...
* **Associated Passages:** Colossians 4:4
* **Associated Articles:** Assumed Knowledge and Implicit Information (ID: `33273@UWTranslationNotes`)
...
Paul assumes that his readers will understand that the phrase **my fellow prisoner** identifies Aristarchus as someone who is in prison along with Paul. You could include this information if that would be helpful to your readers. Alternate translation: \[who has been imprisoned with me]
