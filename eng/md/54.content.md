...
## 1 Timothy - Introduction (id: en_tn_1TI_wy83)
...
* **Associated Passages:** 1 Timothy 0:0
* **Associated Articles:** How to Translate Names (ID: `33391@UWTranslationNotes`); Metaphor (ID: `33292@UWTranslationNotes`); Exclusive and Inclusive ‘We’ (ID: `33271@UWTranslationNotes`); Forms of ‘You’ — Singular (ID: `33321@UWTranslationNotes`); Textual Variants (ID: `33405@UWTranslationNotes`)


## 1 Timothy - Chapter 1 Introduction (id: en_tn_1TI_a4v2)

1 Timothy 1 Chapter Introduction
================================
...
* **Associated Passages:** 1 Timothy 1:0
* **Associated Articles:** Metaphor (ID: `33292@UWTranslationNotes`); Metaphor (ID: `33292@UWTranslationNotes`); Metaphor (ID: `33292@UWTranslationNotes`)
...
* **Associated Passages:** 1 Timothy 1:3-4
* **Associated Articles:** Assumed Knowledge and Implicit Information (ID: `33273@UWTranslationNotes`)
...
## 1 Timothy - Chapter 2 Introduction (id: en_tn_1TI_c6rf)

1 Timothy 2 Chapter Introduction
================================
...
* **Associated Passages:** 1 Timothy 2:0
...
## 1 Timothy - Chapter 3 Introduction (id: en_tn_1TI_d9db)

1 Timothy 3 Chapter Introduction
================================
...
* **Associated Passages:** 1 Timothy 3:0
* **Associated Articles:** When Masculine Words Include Women (ID: `33276@UWTranslationNotes`); Generic Noun Phrases (ID: `33277@UWTranslationNotes`)
...
## 1 Timothy - Chapter 4 Introduction (id: en_tn_1TI_b39h)

1 Timothy 4 Chapter Introduction
================================
...
* **Associated Passages:** 1 Timothy 4:0
* **Associated Articles:** Metaphor (ID: `33292@UWTranslationNotes`)
...
* **Associated Passages:** 1 Timothy 4:8-10
* **Associated Articles:** Quote Markings (ID: `33306@UWTranslationNotes`)
...
## 1 Timothy - Chapter 5 Introduction (id: en_tn_1TI_jx4e)

1 Timothy 5 Chapter Introduction
================================
...
* **Associated Passages:** 1 Timothy 5:0
...
Paul quotes from the Old Testament Scriptures, specifically from Deuteronomy 25:4\. Then he quotes something that Jesus said, which can be found in Luke 10:7\. If it would be helpful to your readers, you could format these words in a different way and include this information in a footnote. Alternate translation: \[the Scripture says in Deuteronomy, “You will not muzzle an ox threshing,” and in the Gospel of Luke, “The worker is worthy of his wages]
...
## 1 Timothy 5:21 (#1) (id: en_tn_1TI_x0zp)

**διαμαρτύρομαι ἐνώπιον τοῦ Θεοῦ, καὶ Χριστοῦ Ἰησοῦ, καὶ τῶν ἐκλεκτῶν ἀγγέλων, ἵνα**

**"I declare before God and Christ Jesus and the chosen angels that"**
...
## 1 Timothy - Chapter 6 Introduction (id: en_tn_1TI_rks4)

1 Timothy 6 Chapter Introduction
================================
...
* **Associated Passages:** 1 Timothy 6:0
* **Associated Articles:** Metaphor (ID: `33292@UWTranslationNotes`)
...
* **Associated Passages:** 1 Timothy 6:4-5
* **Associated Articles:** Abstract Nouns (ID: `33257@UWTranslationNotes`)
