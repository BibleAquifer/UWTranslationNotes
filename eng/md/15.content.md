...
* **Associated ACAI Concepts:** Tribe of Judah (ID: `group:Judah`); LORD (ID: `deity:Lord`); Jerusalem (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Judah (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Tribe of Benjamin (ID: `group:Benjamin`); Tribe of Levi (ID: `group:Levi`); Jerusalem (ID: `place:Jerusalem`); Tribe of Judah (ID: `group:Judah`); LORD (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); Benjamin (ID: `person:Benjamin`); Judah (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mithredath (ID: `person:Mithredath`); Tribe of Judah (ID: `group:Judah`); Persia (ID: `place:Persia`); Zerubbabel (ID: `person:Zerubbabel.2`); Judah (ID: `person:Judah.4`); Cyrus (ID: `person:Cyrus`)
...
* **Associated ACAI Concepts:** Tribe of Judah (ID: `group:Judah`); Jerusalem (ID: `place:Jerusalem`); Babylon (ID: `place:Babylon`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Judah (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Bigvai (ID: `person:Bigvai`); Baanah (ID: `person:Baanah.3`); Mordecai (ID: `person:Mordecai`); Bilshan (ID: `person:Bilshan`); Mispar (ID: `person:Mispar`); Reelaiah (ID: `person:Reelaiah`); Seraiah (ID: `person:Seraiah.6`); Nehemiah (ID: `person:Nehemiah`); Rehum (ID: `person:Rehum`); Joshua (ID: `person:Joshua.5`); Zerubbabel (ID: `person:Zerubbabel.2`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Talmon (ID: `person:Talmon`); Shobai (ID: `person:Shobai`); Ater (ID: `person:Ater.2`); Hatita (ID: `person:Hatita`); Shallum (ID: `person:Shallum.8`); Akkub (ID: `person:Akkub.2`)
...
* **Associated ACAI Concepts:** Nephushesim (ID: `group:Nephushesim`); Meunim (ID: `group:Meunim`); Asnah (ID: `person:Asnah`)
...
* **Associated ACAI Concepts:** Ami (ID: `person:Ami`); Hattil (ID: `person:Hattil`); Pochereth-hazzebaim (ID: `person:Pochereth-hazzebaim`); Shephatiah (ID: `person:Shephatiah.7`)
...
* **Associated ACAI Concepts:** Barzillai (ID: `person:Barzillai.3`); Habaiah (ID: `person:Habaiah`); Hakkoz (ID: `person:Hakkoz.2`); Gilead (ID: `place:Gilead`); Gileadites (ID: `group:Gilead`); Barzillai (ID: `person:Barzillai`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); LORD (ID: `deity:Lord`); Terror (ID: `keyterm:Terror`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
**"Then they made the Festival of Huts"**
...
* **Associated ACAI Concepts:** Appointed Feast (ID: `keyterm:AppointedFeast`); Offering (ID: `keyterm:Offering`); LORD (ID: `deity:Lord`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** Tyrians (ID: `group:Tyre`); Joppa (ID: `place:Joppa`); Sidonians (ID: `group:Sidon`); Persia (ID: `place:Persia`); Sidon (ID: `place:Sidon`); Tyre (ID: `place:Tyre`); Lebanon (ID: `place:Lebanon`); Cyrus (ID: `person:Cyrus`); Cedar (ID: `flora:Cedar`); Olive Oil (ID: `realia:OliveOil`); Money (ID: `realia:Money`); Craftsman (ID: `realia:Craftsman`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated Passages:** Ezra 3:7
* **Associated Articles:** Connect — Goal (Purpose) Relationship (ID: `33330@UWTranslationNotes`)
...
* **Associated ACAI Concepts:** Tribe of Levi (ID: `group:Levi`); Jehozadak (ID: `person:Jehozadak`); Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Joshua (ID: `person:Joshua.5`); Levi (ID: `person:Levi.3`); Shealtiel (ID: `person:Shealtiel.2`); Zerubbabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Kadmiel (ID: `person:Kadmiel`); Henadad (ID: `person:Henadad`); Jeshua (ID: `person:Jeshua.4`); Hodaviah (ID: `person:Hodaviah.4`); Tribe of Levi (ID: `group:Levi`); LORD (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); Hodiah (ID: `person:Hodiah.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Asaph (ID: `person:Asaph.2`); Tribe of Levi (ID: `group:Levi`); LORD (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); Israel (ID: `person:Israel`); David (ID: `person:David`); Trumpet (ID: `realia:Trumpet`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** Tribe of Benjamin (ID: `group:Benjamin`); Tribe of Judah (ID: `group:Judah`); LORD (ID: `deity:Lord`); Benjamin (ID: `person:Benjamin`); Israel (ID: `person:Israel`); Judah (ID: `person:Judah.4`)
...
* **Associated ACAI Concepts:** Relatives (ID: `group:Relatives`); LORD (ID: `deity:Lord`); Joshua (ID: `person:Joshua.5`); Persia (ID: `place:Persia`); Zerubbabel (ID: `person:Zerubbabel.2`); Israel (ID: `person:Israel`); Cyrus (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Persia (ID: `place:Persia`); Counsel (ID: `keyterm:Counsel`); Darius (ID: `person:Darius.2`); Cyrus (ID: `person:Cyrus`)
...
* **Associated ACAI Concepts:** Dinaite (ID: `person:Dinaite`); Erech (ID: `place:Erech`); Rehum (ID: `person:Rehum.2`); Babylonians (ID: `group:Babylon`); Shimshai (ID: `person:Shimshai`); Persians (ID: `group:Persia`); Susa (ID: `place:Susa`); Elam (ID: `place:Elam`); Babylon (ID: `place:Babylon`); Persia (ID: `place:Persia`); Elamites (ID: `group:Elam`)
...
**"QUOTE\_NOT\_FOUND: ו⁠שורי שַׁכְלִ֔ילוּ וְ⁠אֻשַּׁיָּ֖⁠א יַחִֽיטוּ"**
...
* **Associated ACAI Concepts:** Shimshai (ID: `person:Shimshai`); Rehum (ID: `person:Rehum.2`); Samaria (ID: `place:Samaria`); Euphrates River (ID: `place:Euphrates`)
...
* **Associated ACAI Concepts:** Iddo (ID: `person:Iddo.6`); Haggai (ID: `person:Haggai`); Zechariah (ID: `person:Zechariah.17`); Jews (ID: `group:Jews`); Jerusalem (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Judah (ID: `person:Judah.4`)
...
* **Associated Passages:** Ezra 5:1
* **Associated Articles:** Connect — Simultaneous Time Relationship (ID: `33334@UWTranslationNotes`)
...
* **Associated ACAI Concepts:** Jehozadak (ID: `person:Jehozadak`); Jerusalem (ID: `place:Jerusalem`); Joshua (ID: `person:Joshua.5`); Shealtiel (ID: `person:Shealtiel.2`); Zerubbabel (ID: `person:Zerubbabel.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Babylon (ID: `place:Babylon`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Zerubbabel (ID: `person:Zerubbabel.2`); Cyrus (ID: `person:Cyrus`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Babylon (ID: `place:Babylon`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Shethar-bozenai (ID: `person:Shethar-bozenai`); Euphrates River (ID: `place:Euphrates`); Darius (ID: `person:Darius.2`); Tattenai (ID: `person:Tattenai`)
...
* **Associated ACAI Concepts:** Darius (ID: `person:Darius.2`); Zechariah (ID: `person:Zechariah.17`); Jews (ID: `group:Jews`); Iddo (ID: `person:Iddo.6`); Haggai (ID: `person:Haggai`); Artaxerxes (ID: `person:Artaxerxes`); Persia (ID: `place:Persia`); Israel (ID: `person:Israel`); Cyrus (ID: `person:Cyrus`)
...
**"So the sons of the exile made the Passover"**
...
**"Then they made the Festival of Unleavened Bread seven days with joy"**
...
**"Then they made the Festival of Unleavened Bread seven days with joy, because Yahweh had caused them to be joyful, and had caused the heart of the king of Assyria to turn toward them, to strengthen their hands in the work of the house of God, the God of Israel"**
...
* **Associated ACAI Concepts:** Seraiah (ID: `person:Seraiah.2`); Azariah (ID: `person:Azariah.7`); Ezra (ID: `person:Ezra`); Persia (ID: `place:Persia`); Artaxerxes (ID: `person:Artaxerxes`); Hilkiah (ID: `person:Hilkiah.2`)
...
* **Associated ACAI Concepts:** Ezra (ID: `person:Ezra`); LORD (ID: `deity:Lord`); Moses (ID: `person:Moses`); Babylon (ID: `place:Babylon`); Instruction (ID: `keyterm:Instruction`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Tribe of Levi (ID: `group:Levi`); Jerusalem (ID: `place:Jerusalem`); Artaxerxes (ID: `person:Artaxerxes`); Levi (ID: `person:Levi.3`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Money (ID: `realia:Money`); Sheep (ID: `fauna:Lamb`); Tabernacle Altar (ID: `realia:TabernacleAltar`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Hattush (ID: `person:Hattush.2`); Daniel (ID: `person:Daniel.2`); Gershom (ID: `person:Gershom.2`); Ithamar (ID: `person:Ithamar`); Phinehas (ID: `person:Phinehas`); David (ID: `person:David`)
...
* **Associated ACAI Concepts:** Jeshaiah (ID: `person:Jeshaiah.4`); Athaliah (ID: `person:Athaliah.3`); Elam (ID: `person:Elam`)
...
* **Associated ACAI Concepts:** Eliphelet (ID: `person:Eliphelet.5`); Shemaiah (ID: `person:Shemaiah.14`); Adonikam (ID: `person:Adonikam`); Jeuel (ID: `person:Jeuel.3`)
...
* **Associated ACAI Concepts:** Jarib (ID: `person:Jarib.2`); Joiarib (ID: `person:Joiarib.2`); Zechariah (ID: `person:Zechariah.20`); Elnathan (ID: `person:Elnathan.3`); Ariel (ID: `person:Ariel`); Elnathan (ID: `person:Elnathan.4`); Nathan (ID: `person:Nathan.5`); Eliezer (ID: `person:Eliezer.8`); Elnathan (ID: `person:Elnathan.2`); Meshullam (ID: `person:Meshullam.9`); Shemaiah (ID: `person:Shemaiah.15`); Perceive (ID: `keyterm:Perceive`)
...
* **Associated ACAI Concepts:** Sherebiah (ID: `person:Sherebiah`); Tribe of Levi (ID: `group:Levi`); LORD (ID: `deity:Lord`); Mahli (ID: `person:Mahli`); Levi (ID: `person:Levi.3`); Insight (ID: `keyterm:Insight`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Tribe of Levi (ID: `group:Levi`); LORD (ID: `deity:Lord`); Jerusalem (ID: `place:Jerusalem`); Levi (ID: `person:Levi.3`); Israel (ID: `person:Israel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Tribe of Levi (ID: `group:Levi`); LORD (ID: `deity:Lord`); Jerusalem (ID: `place:Jerusalem`); Levi (ID: `person:Levi.3`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Uriah (ID: `person:Uriah.4`); Eleazar (ID: `person:Eleazar.6`); Jeshua (ID: `person:Jeshua.5`); Phinehas (ID: `person:Phinehas.3`); Jozabad (ID: `person:Jozabad.6`); Noadiah (ID: `person:Noadiah`); Meremoth (ID: `person:Meremoth`); Binnui (ID: `person:Binnui.2`); Tribe of Levi (ID: `group:Levi`); LORD (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); To Sin (ID: `keyterm:Sin`); LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Hittites (ID: `group:Hittite`); Perizzites (ID: `group:Perizzites`); Ammonites (ID: `group:Ammon`); Tribe of Levi (ID: `group:Levi`); Jebusites (ID: `group:Jebusites`); Canaan (ID: `place:Canaan`); Egypt (ID: `place:Egypt`); Moab (ID: `place:Moab`); Levi (ID: `person:Levi.3`); Ammon (ID: `place:Ammon`); Egyptians (ID: `group:Egypt`); Heth (ID: `person:Heth`); Israel (ID: `person:Israel`); Amorites (ID: `group:Amorites`); Canaanites (ID: `group:Canaan`)
...
* **Associated ACAI Concepts:** Judea (ID: `place:Judea`); LORD (ID: `deity:Lord`); Jerusalem (ID: `place:Jerusalem`); Persia (ID: `place:Persia`); Kindness (ID: `keyterm:Kindness`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jehiel (ID: `person:Jehiel.8`); Shecaniah (ID: `person:Shecaniah.7`); Elam (ID: `person:Elam`); LORD (ID: `deity:Lord`); Be Unfaithful (ID: `keyterm:Unfaithful`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** Tribe of Levi (ID: `group:Levi`); Swear (ID: `keyterm:Swear`); Levi (ID: `person:Levi.3`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`)
...
* **Associated ACAI Concepts:** Tribe of Benjamin (ID: `group:Benjamin`); Tribe of Judah (ID: `group:Judah`); Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Benjamin (ID: `person:Benjamin`); Judah (ID: `person:Judah.4`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jahzeiah (ID: `person:Jahzeiah`); Jonathan (ID: `person:Jonathan.10`); Tikvah (ID: `person:Tikvah.2`); Asahel (ID: `person:Asahel.4`); Shabbethai (ID: `person:Shabbethai`); Meshullam (ID: `person:Meshullam.10`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** Jarib (ID: `person:Jarib.3`); Gedaliah (ID: `person:Gedaliah`); Eliezer (ID: `person:Eliezer.9`); Jozadak (ID: `person:Jozadak.2`); Maaseiah (ID: `person:Maaseiah.6`); Jeshua (ID: `person:Jeshua`)
...
* **Associated Passages:** Ezra 10:19
* **Associated Articles:** When to Keep Information Implicit (ID: `33275@UWTranslationNotes`)
...
* **Associated ACAI Concepts:** Elijah (ID: `person:Elijah.3`); Jehiel (ID: `person:Jehiel.9`); Harim (ID: `person:Harim`); Uzziah (ID: `person:Uzziah.4`); Maaseiah (ID: `person:Maaseiah.7`); Shemaiah (ID: `person:Shemaiah.16`)
...
* **Associated ACAI Concepts:** Elasah (ID: `person:Elasah`); Ishmael (ID: `person:Ishmael.6`); Elioenai (ID: `person:Elioenai.4`); Maaseiah (ID: `person:Maaseiah.8`); Jozabad (ID: `person:Jozabad.7`); Nethanel (ID: `person:Nethanel.8`); Pashhur (ID: `person:Pashhur`)
...
* **Associated ACAI Concepts:** Jozabad (ID: `person:Jozabad.8`); Eliezer (ID: `person:Eliezer.10`); Shimei (ID: `person:Shimei.15`); Kelaiah (ID: `person:Kelaiah`); Pethahiah (ID: `person:Pethahiah.2`); Judah (ID: `person:Judah.5`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** Mijamin (ID: `person:Mijamin.2`); Eleazar (ID: `person:Eleazar.7`); Malchijah (ID: `person:Malchijah.4`); Parosh (ID: `person:Parosh`); Izziah (ID: `person:Izziah`); Ramiah (ID: `person:Ramiah`); Benaiah (ID: `person:Benaiah.8`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Jehiel (ID: `person:Jehiel.10`); Mattaniah (ID: `person:Mattaniah.5`); Elijah (ID: `person:Elijah.4`); Zechariah (ID: `person:Zechariah.21`); Jeremoth (ID: `person:Jeremoth.3`); Abdi (ID: `person:Abdi.3`); Elam (ID: `person:Elam`)
...
* **Associated ACAI Concepts:** Elioenai (ID: `person:Elioenai.5`); Eliashib (ID: `person:Eliashib.5`); Mattaniah (ID: `person:Mattaniah.6`); Jeremoth (ID: `person:Jeremoth.4`); Aziza (ID: `person:Aziza`); Zabad (ID: `person:Zabad.5`); Zattu (ID: `person:Zattu.2`)
...
* **Associated ACAI Concepts:** Jehohanan (ID: `person:Jehohanan.5`); Zabbai (ID: `person:Zabbai`); Hananiah (ID: `person:Hananiah.5`); Athlai (ID: `person:Athlai`); Bebai (ID: `person:Bebai`)
...
* **Associated ACAI Concepts:** Sheal (ID: `person:Sheal`); Meshullam (ID: `person:Meshullam.11`); Bani (ID: `person:Bani`); Malluch (ID: `person:Malluch.2`); Adaiah (ID: `person:Adaiah.5`); Jashub (ID: `person:Jashub.2`); Jeremoth (ID: `person:Jeremoth.5`)
...
* **Associated ACAI Concepts:** Manasseh (ID: `person:Manasseh.3`); Bezalel (ID: `person:Bezalel.2`); Benaiah (ID: `person:Benaiah.9`); Mattaniah (ID: `person:Mattaniah.7`); Maaseiah (ID: `person:Maaseiah.9`); Binnui (ID: `person:Binnui.3`); Adna (ID: `person:Adna`); Chelal (ID: `person:Chelal`); Pahath-moab (ID: `person:Pahath-moab`)
...
* **Associated ACAI Concepts:** Eliezer (ID: `person:Eliezer.11`); Shimeon (ID: `person:Shimeon`); Isshijah (ID: `person:Isshijah`); Malchijah (ID: `person:Malchijah.5`); Shemaiah (ID: `person:Shemaiah.17`); Harim (ID: `person:Harim`)
...
* **Associated ACAI Concepts:** Shimei (ID: `person:Shimei.16`); Mattenai (ID: `person:Mattenai`); Mattattah (ID: `person:Mattattah`); Hashum (ID: `person:Hashum`); Manasseh (ID: `person:Manasseh.4`); Jeremai (ID: `person:Jeremai`); Zabad (ID: `person:Zabad.6`); Eliphelet (ID: `person:Eliphelet.6`)
...
* **Associated ACAI Concepts:** Cheluhi (ID: `person:Cheluhi`); Bedeiah (ID: `person:Bedeiah`); Benaiah (ID: `person:Benaiah.10`)
...
* **Associated ACAI Concepts:** Zebina (ID: `person:Zebina`); Jaddai (ID: `person:Jaddai`); Jeiel (ID: `person:Jeiel.8`); Benaiah (ID: `person:Benaiah.11`); Joel (ID: `person:Joel.12`); Zabad (ID: `person:Zabad.7`); Mattithiah (ID: `person:Mattithiah.3`); Nebo (ID: `place:Nebo.2`)
