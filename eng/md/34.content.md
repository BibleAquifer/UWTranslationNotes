...
* **Associated ACAI Concepts:** Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Peace (ID: `keyterm:IntactState`); Vow (ID: `keyterm:Vow`); Wickedness (ID: `keyterm:Wickedness`)
...
* **Associated ACAI Concepts:** Cypress (ID: `flora:Cypress`); Dyed Cloth (ID: `realia:DyedCloth`); Chariot (ID: `realia:Chariot`); Small Shield (ID: `realia:SmallShield`); Fir (ID: `flora:Fir`); Grecian Juniper (ID: `flora:Juniper`); Phoenician Juniper (ID: `flora:JuniperTree`)
...
* **Associated ACAI Concepts:** Lion (ID: `fauna:Lion`); Grass (ID: `flora:Grass`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Put (ID: `place:Put`); Egypt (ID: `place:Egypt`); Libya (ID: `place:Libya`); Cush (ID: `place:Cush.2`)
