...
* **Associated ACAI Concepts:** Judah (ID: `person:Judah.4`); Vow (ID: `keyterm:Vow`); Wickedness (ID: `keyterm:Wickedness`); Tribe of Judah (ID: `group:Judah`); Peace (ID: `keyterm:IntactState`)
...
* **Associated ACAI Concepts:** Small Shield (ID: `realia:SmallShield`); Grecian Juniper (ID: `flora:Juniper`); Dyed Cloth (ID: `realia:DyedCloth`); Chariot (ID: `realia:Chariot`); Fir (ID: `flora:Fir`); Cypress (ID: `flora:Cypress`); Phoenician Juniper (ID: `flora:JuniperTree`)
...
* **Associated ACAI Concepts:** Horse (ID: `fauna:Horse`); Chariot (ID: `realia:Chariot`); Wagon (ID: `realia:Wagon`); Whip (ID: `realia:Whip`)
...
* **Associated ACAI Concepts:** Put (ID: `place:Put`); Cush (ID: `place:Cush.2`); Egypt (ID: `place:Egypt`); Libya (ID: `place:Libya`)
