...
* **Associated ACAI Concepts:** Vow (ID: `keyterm:Vow`); Judah (ID: `person:Judah.4`); Wickedness (ID: `keyterm:Wickedness`); Tribe of Judah (ID: `group:Judah`); Peace (ID: `keyterm:IntactState`)
...
* **Associated ACAI Concepts:** Chariot (ID: `realia:Chariot`); Cypress (ID: `flora:Cypress`); Grecian Juniper (ID: `flora:Juniper`); Fir (ID: `flora:Fir`); Dyed Cloth (ID: `realia:DyedCloth`); Small Shield (ID: `realia:SmallShield`); Phoenician Juniper (ID: `flora:JuniperTree`)
...
* **Associated ACAI Concepts:** Libya (ID: `place:Libya`); Cush (ID: `place:Cush.2`); Egypt (ID: `place:Egypt`); Put (ID: `place:Put`)
