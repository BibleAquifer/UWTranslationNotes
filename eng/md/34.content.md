...
* **Associated ACAI Concepts:** Peace (ID: `keyterm:IntactState`); Vow (ID: `keyterm:Vow`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Wickedness (ID: `keyterm:Wickedness`)
...
* **Associated ACAI Concepts:** Phoenician Juniper (ID: `flora:JuniperTree`); Chariot (ID: `realia:Chariot`); Fir (ID: `flora:Fir`); Dyed Cloth (ID: `realia:DyedCloth`); Small Shield (ID: `realia:SmallShield`); Cypress (ID: `flora:Cypress`); Grecian Juniper (ID: `flora:Juniper`)
