...
* **Associated ACAI Concepts:** Strength (ID: `keyterm:Strength`); The Way (ID: `keyterm:TheWay`); LORD (ID: `deity:Lord`); Pronounce Innocent (ID: `keyterm:PronounceInnocent`)
...
* **Associated ACAI Concepts:** Chariot (ID: `realia:Chariot`); Small Shield (ID: `realia:SmallShield`); Fir (ID: `flora:Fir`); Grecian Juniper (ID: `flora:Juniper`); Cypress (ID: `flora:Cypress`); Dyed Cloth (ID: `realia:DyedCloth`); Phoenician Juniper (ID: `flora:JuniperTree`)
...
* **Associated ACAI Concepts:** Chariot (ID: `realia:Chariot`); Whip (ID: `realia:Whip`); Horse (ID: `fauna:Horse`); Wagon (ID: `realia:Wagon`)
...
* **Associated ACAI Concepts:** Put (ID: `place:Put`); Libya (ID: `place:Libya`); Cush (ID: `place:Cush.2`); Egypt (ID: `place:Egypt`)
