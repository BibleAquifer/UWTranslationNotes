...
* **Associated ACAI Concepts:** Fir (ID: `flora:Fir`); Grecian Juniper (ID: `flora:Juniper`); Phoenician Juniper (ID: `flora:JuniperTree`); Dyed Cloth (ID: `realia:DyedCloth`); Chariot (ID: `realia:Chariot`); Cypress (ID: `flora:Cypress`); Small Shield (ID: `realia:SmallShield`)
...
* **Associated ACAI Concepts:** Chariot (ID: `realia:Chariot`); Wagon (ID: `realia:Wagon`); Whip (ID: `realia:Whip`); Horse (ID: `fauna:Horse`)
