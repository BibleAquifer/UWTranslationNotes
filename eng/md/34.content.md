...
* **Associated ACAI Concepts:** Wickedness (ID: `keyterm:Wickedness`); Peace (ID: `keyterm:IntactState`); Vow (ID: `keyterm:Vow`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Phoenician Juniper (ID: `flora:JuniperTree`); Cypress (ID: `flora:Cypress`); Grecian Juniper (ID: `flora:Juniper`); Chariot (ID: `realia:Chariot`); Fir (ID: `flora:Fir`); Dyed Cloth (ID: `realia:DyedCloth`); Small Shield (ID: `realia:SmallShield`)
...
* **Associated ACAI Concepts:** Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Lion (ID: `fauna:Lion`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Chariot (ID: `realia:Chariot`); Wagon (ID: `realia:Wagon`); Horse (ID: `fauna:Horse`); Whip (ID: `realia:Whip`)
...
* **Associated ACAI Concepts:** Libya (ID: `place:Libya`); Put (ID: `place:Put`); Egypt (ID: `place:Egypt`); Cush (ID: `place:Cush.2`)
