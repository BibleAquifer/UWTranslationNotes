...
* **Associated ACAI Concepts:** Vow (ID: `keyterm:Vow`); Judah (ID: `person:Judah.4`); Peace (ID: `keyterm:IntactState`); Wickedness (ID: `keyterm:Wickedness`); Tribe of Judah (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Libya (ID: `place:Libya`); Cush (ID: `place:Cush.2`); Put (ID: `place:Put`); Egypt (ID: `place:Egypt`)
