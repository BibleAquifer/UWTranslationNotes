...
* **Associated ACAI Concepts:** Peace (ID: `keyterm:IntactState`); Judah (ID: `person:Judah.4`); Wickedness (ID: `keyterm:Wickedness`); Vow (ID: `keyterm:Vow`); Tribe of Judah (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Cush (ID: `place:Cush.2`); Egypt (ID: `place:Egypt`); Libya (ID: `place:Libya`); Put (ID: `place:Put`)
