...
* **Associated ACAI Concepts:** Vow (ID: `keyterm:Vow`); Peace (ID: `keyterm:IntactState`); Wickedness (ID: `keyterm:Wickedness`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Cush (ID: `place:Cush.2`); Put (ID: `place:Put`); Egypt (ID: `place:Egypt`); Libya (ID: `place:Libya`)
