...
* **Associated ACAI Concepts:** Vow (ID: `keyterm:Vow`); Tribe of Judah (ID: `group:Judah`); Wickedness (ID: `keyterm:Wickedness`); Peace (ID: `keyterm:IntactState`); Judah (ID: `person:Judah.4`)
