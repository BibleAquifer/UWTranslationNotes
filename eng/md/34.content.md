...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Pronounce Innocent (ID: `keyterm:PronounceInnocent`); Strength (ID: `keyterm:Strength`); The Way (ID: `keyterm:TheWay`)
...
* **Associated ACAI Concepts:** Vow (ID: `keyterm:Vow`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Wickedness (ID: `keyterm:Wickedness`); Peace (ID: `keyterm:IntactState`)
...
* **Associated ACAI Concepts:** Grecian Juniper (ID: `flora:Juniper`); Chariot (ID: `realia:Chariot`); Small Shield (ID: `realia:SmallShield`); Fir (ID: `flora:Fir`); Phoenician Juniper (ID: `flora:JuniperTree`); Dyed Cloth (ID: `realia:DyedCloth`); Cypress (ID: `flora:Cypress`)
...
* **Associated ACAI Concepts:** Chariot (ID: `realia:Chariot`); Whip (ID: `realia:Whip`); Wagon (ID: `realia:Wagon`); Horse (ID: `fauna:Horse`)
