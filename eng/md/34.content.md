...
* **Associated ACAI Concepts:** Wickedness (ID: `keyterm:Wickedness`); Judah (ID: `person:Judah.4`); Vow (ID: `keyterm:Vow`); Tribe of Judah (ID: `group:Judah`); Peace (ID: `keyterm:IntactState`)
...
* **Associated ACAI Concepts:** Egypt (ID: `place:Egypt`); Cush (ID: `place:Cush.2`); Put (ID: `place:Put`); Libya (ID: `place:Libya`)
