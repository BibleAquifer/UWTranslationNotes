...
* **Associated Passages:** 3 John 0:1
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); Bear Witness (ID: `keyterm:BearWitness`); Church (ID: `keyterm:Church`); LORD (ID: `deity:Lord`); Love (ID: `keyterm:Love`)
